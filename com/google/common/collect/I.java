...
abstract class i {
    ...
    static int f(Object object0, Object object1, int v, Object object2, int[] arr_v, Object[] arr_object, Object[] arr_object1) {
        int v1 = l.c(object0);
        int v2 = v1 & v;
        int v3 = i.h(object2, v2);
        if(v3 == 0) {
            return -1;
        }
        int v4 = -1;
        while(true) {
            int v5 = arr_v[v3 - 1];
            if((v5 & ~v) == (v1 & ~v) && f.a(object0, arr_object[v3 - 1]) && (arr_object1 == null || f.a(object1, arr_object1[v3 - 1]))) {
                int v6 = v5 & v;
                if(v4 == -1) {
                    i.i(object2, v2, v6);
                    return v3 - 1;
                }
                arr_v[v4] = i.d(arr_v[v4], v6, v);
                return v3 - 1;
            }
            int v7 = v5 & v;
            if(v7 == 0) {
