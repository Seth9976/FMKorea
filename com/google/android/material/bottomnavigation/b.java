...
public class b extends f {
    ...
    public b(Context context0) {
        ...
        this.M = resources0.getDimensionPixelSize(c.d);
        this.N = resources0.getDimensionPixelSize(c.e);
        this.O = resources0.getDimensionPixelSize(c.b);
        this.P = resources0.getDimensionPixelSize(c.c);
    }

    @Override  // com.google.android.material.navigation.f
    protected d g(Context context0) {
    ...
    protected void onMeasure(int v, int v1) {
        ...
        int v3 = this.getMenu().G().size();
        int v4 = this.getChildCount();
        this.R.clear();
        int v5 = View.MeasureSpec.getSize(v1);
        int v6 = View.MeasureSpec.makeMeasureSpec(v5, 0x40000000);
        int v8 = 1;
        if(!this.h(this.getLabelVisibilityMode(), v3) || !this.n()) {
            if(v3 != 0) {
                v8 = v3;
            }
            int v17 = Math.min(v2 / v8, this.O);
            int v18 = v2 - v3 * v17;
            ...
            int v9 = this.P;
            if(view0.getVisibility() != 8) {
                view0.measure(View.MeasureSpec.makeMeasureSpec(this.O, 0x80000000), v6);
                v9 = Math.max(v9, view0.getMeasuredWidth());
            }
            int v10 = v3 - (view0.getVisibility() == 8 ? 0 : 1);
            int v11 = Math.min(v2 - this.N * v10, Math.min(v9, this.O));
            int v12 = v2 - v11;
            if(v10 != 0) {
                v8 = v10;
            }
            int v13 = Math.min(v12 / v8, this.M);
            int v14 = v12 - v10 * v13;
        ...
        for(int v7 = 0; v7 < v4; ++v7) {
            ...
            if(view1.getVisibility() != 8) {
                view1.measure(View.MeasureSpec.makeMeasureSpec(((int)(((Integer)this.R.get(v7)))), 0x40000000), v6);
