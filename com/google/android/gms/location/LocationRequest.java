...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    public static final class Builder {
        ...
        public LocationRequest build() {
            ...
            long v3 = Math.max(this.zzd, this.zzb);
            long v4 = this.zze;
            int v5 = this.zzf;
            float f = this.zzg;
            boolean z = this.zzh;
            return this.zzi == -1L ? new LocationRequest(v, v1, v2, v3, 0x7FFFFFFFFFFFFFFFL, v4, v5, f, z, this.zzb, this.zzj, this.zzk, this.zzl, new WorkSource(this.zzm), this.zzn) : new LocationRequest(v, v1, v2, v3, 0x7FFFFFFFFFFFFFFFL, v4, v5, f, z, this.zzi, this.zzj, this.zzk, this.zzl, new WorkSource(this.zzm), this.zzn);
        }
    ...
    public LocationRequest setFastestInterval(long v) {
        ...
        Preconditions.checkArgument(z, "illegal fastest interval: %d", arr_object);
        this.zzc = v;
        return this;
    }
    ...
    public LocationRequest setMaxWaitTime(long v) {
        ...
        Preconditions.checkArgument(z, "illegal max wait time: %d", arr_object);
        this.zzd = v;
        return this;
    }
