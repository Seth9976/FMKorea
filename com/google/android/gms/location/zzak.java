...
public final class zzak {
    ...
    public static StringBuilder zza(Location location0, StringBuilder stringBuilder0) {
        ...
        if(location0.hasAltitude()) {
            ...
            if(a.l(location0)) {
                stringBuilder0.append("±");
                stringBuilder0.append(decimalFormat0.format(((double)a.i(location0))));
            }
            stringBuilder0.append("m");
        }
        if(location0.hasSpeed()) {
            ...
            if(a.k(location0)) {
                stringBuilder0.append("±");
                stringBuilder0.append(decimalFormat1.format(((double)a.h(location0))));
            }
        ...
        if(location0.hasBearing()) {
            ...
            if(a.j(location0)) {
                stringBuilder0.append("±");
                stringBuilder0.append(decimalFormat2.format(((double)a.b(location0))));
            }
            stringBuilder0.append("°");
        }
        ...
        stringBuilder0.append(zzeo.zza(a.c(location0) + (System.currentTimeMillis() - v)));
        stringBuilder0.append('}');
        return stringBuilder0;
    }
}
