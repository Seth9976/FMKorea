...
public final class zzb extends AbstractSafeParcelable {
    ...
    @Constructor
    zzb(@Param(id = 1) long v, @Param(id = 2) boolean z, @Param(id = 3) WorkSource workSource0, @Param(id = 4) String s, @Param(id = 5) int[] arr_v, @Param(id = 6) boolean z1, @Param(id = 7) String s1, @Param(id = 8) long v1, @Param(id = 9) String s2) {
        this.zza = v;
        this.zzb = z;
