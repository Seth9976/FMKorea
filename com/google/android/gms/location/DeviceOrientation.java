...
public class DeviceOrientation extends AbstractSafeParcelable {
    ...
    @Constructor
    DeviceOrientation(@Param(id = 1) float[] arr_f, @Param(id = 4) float f, @Param(id = 5) float f1, @Param(id = 6) long v, @Param(id = 7) byte b, @Param(id = 8) float f2, @Param(id = 9) float f3) {
        DeviceOrientation.zzj(arr_f);
        boolean z = true;
    ...
    public String toString() {
        StringBuilder stringBuilder0 = new StringBuilder("DeviceOrientation[");
        stringBuilder0.append("attitude=");
