...
public final class CurrentLocationRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    CurrentLocationRequest(@Param(id = 1) long v, @Param(id = 2) int v1, @Param(id = 3) int v2, @Param(id = 4) long v3, @Param(id = 5) boolean z, @Param(id = 7) int v4, @Param(id = 6) WorkSource workSource0, @Param(id = 9) zze zze0) {
        this.zza = v;
        this.zzb = v1;
        this.zzc = v2;
        this.zzd = v3;
