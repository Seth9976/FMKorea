...
public final class zzbu {
    ...
    public static Bundle zza(JSONObject jSONObject0) {
        ...
        while(iterator0.hasNext()) {
            ...
            if(object1 == null) {
                ...
                if(object2 == null) {
                    zzcaa.zzj(("Expected JSONArray with at least 1 non-null element for key:" + s));
                }
                else if(object2 instanceof JSONObject) {
                    Bundle[] arr_bundle = new Bundle[v];
                    for(int v2 = 0; v2 < v; ++v2) {
                        arr_bundle[v2] = jSONArray0.isNull(v2) ? null : zzbu.zza(jSONArray0.optJSONObject(v2));
                    }
                    ...
                    zzcaa.zzj(String.format("JSONArray with unsupported type %s for key:%s", object2.getClass().getCanonicalName(), s));
                }
            }
            else if(object1 instanceof JSONObject) {
                bundle0.putBundle(s, zzbu.zza(((JSONObject)object1)));
            }
            else {
                zzcaa.zzj(("Unsupported type for key:" + s));
            }
        }
        return bundle0;
    }
    ...
    public static String zzb(String s, JSONObject jSONObject0, String[] arr_s) {
        JSONObject jSONObject1 = zzbu.zzm(jSONObject0, arr_s);
        return jSONObject1 == null ? "" : jSONObject1.optString(arr_s[0], "");
    }

    public static List zzc(JSONArray jSONArray0, List list0) {
        if(list0 == null) {
            list0 = new ArrayList();
        }
        if(jSONArray0 != null) {
    ...
    public static List zzd(JsonReader jsonReader0) {
    ...
    public static JSONArray zze(JsonReader jsonReader0) {
        JSONArray jSONArray0 = new JSONArray();
        jsonReader0.beginArray();
        while(jsonReader0.hasNext()) {
            JsonToken jsonToken0 = jsonReader0.peek();
            if(JsonToken.BEGIN_ARRAY.equals(jsonToken0)) {
                jSONArray0.put(zzbu.zze(jsonReader0));
            }
            else if(JsonToken.BEGIN_OBJECT.equals(jsonToken0)) {
                jSONArray0.put(zzbu.zzh(jsonReader0));
            }
    ...
    public static JSONObject zzf(JSONObject jSONObject0, String s) {
        try {
    ...
    public static JSONObject zzg(JSONObject jSONObject0, String[] arr_s) {
        JSONObject jSONObject1 = zzbu.zzm(jSONObject0, arr_s);
        return jSONObject1 == null ? null : jSONObject1.optJSONObject(arr_s[1]);
    }

    public static JSONObject zzh(JsonReader jsonReader0) {
        ...
        while(jsonReader0.hasNext()) {
            ...
            JsonToken jsonToken0 = jsonReader0.peek();
            if(JsonToken.BEGIN_ARRAY.equals(jsonToken0)) {
                jSONObject0.put(s, zzbu.zze(jsonReader0));
            }
            else if(JsonToken.BEGIN_OBJECT.equals(jsonToken0)) {
                jSONObject0.put(s, zzbu.zzh(jsonReader0));
            }
            else if(JsonToken.BOOLEAN.equals(jsonToken0)) {
    ...
    public static void zzi(JsonWriter jsonWriter0, JSONArray jSONArray0) {
        try {
    ...
    public static void zzj(JsonWriter jsonWriter0, JSONObject jSONObject0) {
        try {
            ...
            while(iterator0.hasNext()) {
                ...
                if(object1 instanceof String) {
                    ...
                    zzbu.zzj(jsonWriter0.name(s), ((JSONObject)object1));
                }
                else {
                    if(!(object1 instanceof JSONArray)) {
                        throw new JSONException("unable to write field: " + object1);
                    }
                    zzbu.zzi(jsonWriter0.name(s), ((JSONArray)object1));
                }
            }
    ...
    public static boolean zzk(boolean z, JSONObject jSONObject0, String[] arr_s) {
        JSONObject jSONObject1 = zzbu.zzm(jSONObject0, arr_s);
        return jSONObject1 == null ? false : jSONObject1.optBoolean(arr_s[arr_s.length - 1], false);
    }

    public static String zzl(zzfbk zzfbk0) {
        if(zzfbk0 != null) {
            StringWriter stringWriter0 = new StringWriter();
            try {
                JsonWriter jsonWriter0 = new JsonWriter(stringWriter0);
                zzbu.zzn(jsonWriter0, zzfbk0);
                jsonWriter0.close();
                return stringWriter0.toString();
            }
            catch(IOException iOException0) {
                zzcaa.zzh("Error when writing JSON.", iOException0);
            }
        }
        return null;
    }

    private static JSONObject zzm(JSONObject jSONObject0, String[] arr_s) {
    ...
    private static void zzn(JsonWriter jsonWriter0, Object object0) {
        if(object0 == null) {
        ...
        if(object0 instanceof zzfbk) {
            zzbu.zzj(jsonWriter0, ((zzfbk)object0).zzd);
            return;
        }
        if(object0 instanceof Map) {
            ...
            for(Object object1: ((Map)object0).entrySet()) {
                ...
                if(object2 instanceof String) {
                    ...
                    zzbu.zzn(jsonWriter0.name(((String)object2)), object3);
                }
            }
            jsonWriter0.endObject();
            return;
