...
public final class zzbf {
    ...
    zzbf(zzbd zzbd0, zzbe zzbe0) {
        int v = zzbd0.zzb.size();
        this.zza = (String[])zzbd0.zza.toArray(new String[v]);
        this.zzb = zzbf.zzc(zzbd0.zzb);
        this.zzc = zzbf.zzc(zzbd0.zzc);
        this.zzd = new int[v];
        this.zze = 0;
    }
    ...
    public final List zza() {
        ...
        for(int v = 0; true; ++v) {
            ...
            int v1 = this.zzd[v];
            list0.add(new zzbc(s, f, f1, ((double)v1) / ((double)this.zze), v1));
        }
        return list0;
    }
