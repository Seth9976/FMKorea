...
public final class zzj extends AbstractSafeParcelable {
    ...
    @Constructor
    zzj(@Param(id = 2) boolean z, @Param(id = 3) boolean z1, @Param(id = 4) String s, @Param(id = 5) boolean z2, @Param(id = 6) float f, @Param(id = 7) int v, @Param(id = 8) boolean z3, @Param(id = 9) boolean z4, @Param(id = 10) boolean z5) {
        this.zza = z;
        this.zzb = z1;
        this.zzc = s;
        this.zzd = z2;
    ...
    public zzj(boolean z, boolean z1, boolean z2, float f, int v, boolean z3, boolean z4, boolean z5) {
