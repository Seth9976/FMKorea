...
public final class zze extends AbstractSafeParcelable {
    ...
    @Constructor
    public zze(@Param(id = 1) int v, @Param(id = 2) String s, @Param(id = 3) String s1, @Param(id = 4) zze zze0, @Param(id = 5) IBinder iBinder0) {
        this.zza = v;
        this.zzb = s;
        this.zzc = s1;
        this.zzd = zze0;
    ...
    public final LoadAdError zzb() {
        ...
        if(iBinder0 != null) {
            ...
            if(iInterface0 instanceof zzdn) {
                return new LoadAdError(v, s, s1, adError0, ResponseInfo.zza(((zzdn)iInterface0)));
            }
            zzdn0 = new zzdl(iBinder0);
        }
        return new LoadAdError(v, s, s1, adError0, ResponseInfo.zza(zzdn0));
    }
}
