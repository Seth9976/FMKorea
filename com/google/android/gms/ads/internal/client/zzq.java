...
public final class zzq extends AbstractSafeParcelable {
    ...
    public zzq(Context context0, AdSize[] arr_adSize) {
        ...
        if(z2) {
            ...
            v6 = this.zze;
            this.zzf = zzbzt.zzp(displayMetrics0, this.zze);
        }
        int v7 = v == -2 ? this.zzb : zzq.zzf(displayMetrics0);
        this.zzc = zzbzt.zzp(displayMetrics0, v7);
        if(z2 || v == -2) {
        ...
        if(arr_adSize.length > 1) {
            ...
            for(int v8 = 0; v8 < arr_adSize.length; ++v8) {
                this.zzg[v8] = new zzq(context0, arr_adSize[v8]);
            }
        }
        else {
            this.zzg = null;
    ...
    @Constructor
    zzq(@Param(id = 2) String s, @Param(id = 3) int v, @Param(id = 4) int v1, @Param(id = 5) boolean z, @Param(id = 6) int v2, @Param(id = 7) int v3, @Param(id = 8) zzq[] arr_zzq, @Param(id = 9) boolean z1, @Param(id = 10) boolean z2, @Param(id = 11) boolean z3, @Param(id = 12) boolean z4, @Param(id = 13) boolean z5, @Param(id = 14) boolean z6, @Param(id = 15) boolean z7, @Param(id = 16) boolean z8) {
        this.zza = s;
        this.zzb = v;
        this.zzc = v1;
        this.zzd = z;
    ...
    public static int zza(DisplayMetrics displayMetrics0) {
        return (int)(((float)zzq.zzf(displayMetrics0)) * displayMetrics0.density);
    }
    ...
    private static int zzf(DisplayMetrics displayMetrics0) {
