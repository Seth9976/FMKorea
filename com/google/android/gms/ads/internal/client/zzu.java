...
public final class zzu extends AbstractSafeParcelable {
    ...
    @Constructor
    public zzu(@Param(id = 1) String s, @Param(id = 2) long v, @Param(id = 3) zze zze0, @Param(id = 4) Bundle bundle0, @Param(id = 5) String s1, @Param(id = 6) String s2, @Param(id = 7) String s3, @Param(id = 8) String s4) {
        this.zza = s;
        this.zzb = v;
        this.zzc = zze0;
        this.zzd = bundle0;
