...
public final class zzc extends AbstractSafeParcelable {
    ...
    public zzc(Intent intent0, zzx zzx0) {
        this(null, null, null, null, null, null, null, intent0, ObjectWrapper.wrap(zzx0).asBinder(), false);
    }
    ...
    public zzc(@Param(id = 2) String s, @Param(id = 3) String s1, @Param(id = 4) String s2, @Param(id = 5) String s3, @Param(id = 6) String s4, @Param(id = 7) String s5, @Param(id = 8) String s6, @Param(id = 9) Intent intent0, @Param(id = 10) IBinder iBinder0, @Param(id = 11) boolean z) {
        ...
        this.zzg = s6;
        this.zzh = intent0;
        this.zzi = (zzx)ObjectWrapper.unwrap(Stub.asInterface(iBinder0));
        this.zzj = z;
    }

    public zzc(String s, String s1, String s2, String s3, String s4, String s5, String s6, zzx zzx0) {
        this(s, s1, s2, s3, s4, s5, s6, null, ObjectWrapper.wrap(zzx0).asBinder(), false);
    }
