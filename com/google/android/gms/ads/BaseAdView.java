...
public abstract class BaseAdView extends ViewGroup {
    ...
    protected BaseAdView(Context context0, int v) {
        super(context0);
        this.zza = new zzea(this, v);
    }

    protected BaseAdView(Context context0, AttributeSet attributeSet0, int v) {
        super(context0, attributeSet0);
        this.zza = new zzea(this, attributeSet0, false, v);
    }

    protected BaseAdView(Context context0, AttributeSet attributeSet0, int v, int v1) {
        super(context0, attributeSet0, v);
        this.zza = new zzea(this, attributeSet0, false, v1);
    }

    protected BaseAdView(Context context0, AttributeSet attributeSet0, int v, int v1, boolean z) {
        super(context0, attributeSet0, v);
        this.zza = new zzea(this, attributeSet0, z, v1);
    }

    protected BaseAdView(Context context0, AttributeSet attributeSet0, boolean z) {
        super(context0, attributeSet0);
        this.zza = new zzea(this, attributeSet0, z);
    }

    public void destroy() {
        zzbbr.zza(this.getContext());
        if(((Boolean)zzbdi.zze.zze()).booleanValue() && ((Boolean)zzba.zzc().zzb(zzbbr.zzjZ)).booleanValue()) {
            zze zze0 = new zze(this);
            zzbzp.zzb.execute(zze0);
            return;
        }
        this.zza.zzk();
    }
    ...
    protected void onMeasure(int v, int v1) {
        ...
        if(view0 == null || view0.getVisibility() == 8) {
            try {
                ...
                zzcaa.zzh("Unable to retrieve ad size.", nullPointerException0);
                adSize0 = null;
            }
            if(adSize0 == null) {
                v3 = 0;
    ...
    public void pause() {
        zzbbr.zza(this.getContext());
        if(((Boolean)zzbdi.zzg.zze()).booleanValue() && ((Boolean)zzba.zzc().zzb(zzbbr.zzka)).booleanValue()) {
            zzd zzd0 = new zzd(this);
            zzbzp.zzb.execute(zzd0);
            return;
        }
        this.zza.zzn();
    }
    ...
    public void resume() {
        zzbbr.zza(this.getContext());
        if(((Boolean)zzbdi.zzh.zze()).booleanValue() && ((Boolean)zzba.zzc().zzb(zzbbr.zzjY)).booleanValue()) {
            zzf zzf0 = new zzf(this);
            zzbzp.zzb.execute(zzf0);
            return;
        }
        this.zza.zzp();
    }
