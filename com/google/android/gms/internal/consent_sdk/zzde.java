...
public abstract class zzde extends zzdb implements List, RandomAccess {
                ...
                if(v == ((List)object0).size()) {
                    if(((List)object0) instanceof RandomAccess) {
                        for(int v1 = 0; v1 < v; ++v1) {
                            if(!zzcw.zza(this.get(v1), ((List)object0).get(v1))) {
                                return false;
                            }
                        }
                        return true;
    ...
    public zzde zzf(int v, int v1) {
        zzcx.zzc(v, v1, this.size());
        int v2 = v1 - v;
        if(v2 == this.size()) {
            return this;
        }
        return v2 == 0 ? zzdh.zza : new zzdd(this, v, v2);
    }

    static zzde zzg(Object[] arr_object, int v) {
        return v == 0 ? zzdh.zza : new zzdh(arr_object, v);
    }

    public final zzdl zzh(int v) {
        zzcx.zzb(v, this.size(), "index");
        return this.isEmpty() ? zzde.zza : new zzdc(this, v);
    }
}
