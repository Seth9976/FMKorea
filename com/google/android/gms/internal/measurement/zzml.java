...
final class zzml extends zzmi {
    ...
    final int zza(CharSequence charSequence0, byte[] arr_b, int v, int v1) {
        ...
        label_49:
            ...
            throw new zzmk(v4, v2);
        }
        return v7;
    }

    @Override  // com.google.android.gms.internal.measurement.zzmi
    final String zza(byte[] arr_b, int v, int v1) {
        ...
        while(v < v2) {
            ...
            if(v7 < 0xFFFFFFE0) {
                if(v6 < v2) {
                    v += 2;
                    zzmj.zza(((byte)v7), arr_b[v6], arr_c, v5);
                    ++v5;
                    continue;
                }
            }
                ...
                if(v6 < v2 - 2) {
                    ...
                    int v13 = arr_b[v + 2];
                    v += 4;
                    zzmj.zza(((byte)v7), ((byte)v11), ((byte)v13), arr_b[v12], arr_c, v5);
                    v5 += 2;
                    continue;
                }
            }
                ...
                int v10 = v + 2;
                v += 3;
                zzmj.zza(((byte)v7), arr_b[v6], arr_b[v10], arr_c, v5);
                ++v5;
                continue;
            }
            throw zzji.zzd();
