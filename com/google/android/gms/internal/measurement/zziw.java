...
final class zziw extends zzhg implements zzjf, zzkv, RandomAccess {
    private static final zziw zza;
    private float[] zzb;
    private int zzc;

    static {
        zziw.zza = new zziw(new float[0], 0, false);
    }
    ...
    private zziw(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zziw)) {
            return super.addAll(collection0);
        }
        int v = ((zziw)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zziw)collection0).zzb, 0, this.zzb, this.zzc, ((zziw)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zziw)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zziw)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zziw)object0).zzb;
    ...
    public final zzjf zza(int v) {
        ...
        return new zziw(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
