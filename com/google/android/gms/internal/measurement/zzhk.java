...
final class zzhk extends zzhg implements zzjf, zzkv, RandomAccess {
    private static final zzhk zza;
    private boolean[] zzb;
    private int zzc;

    static {
        zzhk.zza = new zzhk(new boolean[0], 0, false);
    }
    ...
    private zzhk(boolean[] arr_z, int v, boolean z) {
        super(z);
        this.zzb = arr_z;
        this.zzc = v;
    }
    ...
    public final void add(int v, Object object0) {
        ...
        throw new IndexOutOfBoundsException(this.zzb(v));
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzhk)) {
            return super.addAll(collection0);
        }
        int v = ((zzhk)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzhk)collection0).zzb, 0, this.zzb, this.zzc, ((zzhk)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzhk)object0).zzc) {
            return false;
        }
        boolean[] arr_z = ((zzhk)object0).zzb;
    ...
    public final zzjf zza(int v) {
        ...
        return new zzhk(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
    ...
    private final String zzb(int v) {
