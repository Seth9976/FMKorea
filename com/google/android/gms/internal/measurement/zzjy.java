...
final class zzjy extends zzhg implements zzjg, zzkv, RandomAccess {
    private static final zzjy zza;
    private long[] zzb;
    private int zzc;

    static {
        zzjy.zza = new zzjy(new long[0], 0, false);
    }
    ...
    private zzjy(long[] arr_v, int v, boolean z) {
        super(z);
        this.zzb = arr_v;
        this.zzc = v;
    }
    ...
    @Override  // com.google.android.gms.internal.measurement.zzjg
    public final zzjg zzc(int v) {
        if(v < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzjy(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
