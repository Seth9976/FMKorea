...
abstract class zziv {
    ...
    static {
        zziv.zza = Logger.getLogger("com.google.android.gms.internal.measurement.zzig");
        zziv.zzb = "com.google.protobuf.BlazeGeneratedExtensionRegistryLiteLoader";
    }

    static zzik zza(Class class0) {
        zziv zziv0;
        String s;
        Class class1 = zziv.class;
        ClassLoader classLoader0 = class1.getClassLoader();
        if(class0.equals(zzik.class)) {
        ...
        if(class0.getPackage().equals(class1.getPackage())) {
            ...
            label_7:
                ...
                try {
                    zziv0 = (zziv)class2.getConstructor(null).newInstance(null);
                }
                ...
                return (zzik)class0.cast(zziv0.zza());
            }
                ...
                while(iterator0.hasNext()) {
                    try {
                        ...
                        arrayList0.add(((zzik)class0.cast(((zziv)object0).zza())));
                    }
                    catch(ServiceConfigurationError serviceConfigurationError0) {
                        zziv.zza.logp(Level.SEVERE, "com.google.protobuf.GeneratedExtensionRegistryLoader", "load", "Unable to load " + class0.getSimpleName(), serviceConfigurationError0);
                    }
                }
                switch(arrayList0.size()) {
                    ...
                    case 1: {
                        return (zzik)arrayList0.get(0);
                    }
                    default: {
                        try {
                            return (zzik)class0.getMethod("combine", Collection.class).invoke(null, arrayList0);
                        }
