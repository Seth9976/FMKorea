...
public final class zzj {
    public static zzaq zza(zzd zzfp$zzd0) {
        if(zzfp$zzd0 == null) {
            return zzaq.zzc;
        }
        switch(zzfp$zzd0.zzb()) {
            case 1: {
                return zzfp$zzd0.zzj() ? new zzas("") : zzaq.zzj;
            }
            case 2: {
                return zzfp$zzd0.zzi() ? new zzai(zzfp$zzd0.zza()) : new zzai(null);
            }
            case 3: {
                return zzfp$zzd0.zzh() ? new zzag(Boolean.valueOf(zzfp$zzd0.zzg())) : new zzag(null);
            }
            case 4: {
                ArrayList arrayList0 = new ArrayList();
                for(Object object0: zzfp$zzd0.zzf()) {
            ...
            default: {
                throw new IllegalStateException("Invalid entity: " + zzfp$zzd0);
            }
        }
    }
