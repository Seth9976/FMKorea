...
final class zzii extends zzhg implements zzjf, zzkv, RandomAccess {
    private static final zzii zza;
    private double[] zzb;
    private int zzc;

    static {
        zzii.zza = new zzii(new double[0], 0, false);
    }
    ...
    private zzii(double[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final int hashCode() {
        ...
        for(int v1 = 0; v1 < this.zzc; ++v1) {
            v = v * 0x1F + zziz.zza(Double.doubleToLongBits(this.zzb[v1]));
        }
        return v;
    }
    ...
    public final zzjf zza(int v) {
        ...
        return new zzii(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
