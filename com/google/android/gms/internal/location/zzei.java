...
public final class zzei extends AbstractSafeParcelable {
    ...
    @Constructor
    zzei(@Param(id = 1) int v, @Param(id = 2) zzeg zzeg0, @Param(id = 3) IBinder iBinder0, @Param(id = 5) IBinder iBinder1, @Param(id = 4) PendingIntent pendingIntent0, @Param(id = 6) IBinder iBinder2, @Param(id = 8) String s) {
        this.zza = v;
        this.zzb = zzeg0;
        zzr zzr0 = null;
