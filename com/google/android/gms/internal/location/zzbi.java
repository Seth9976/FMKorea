...
public final class zzbi extends GoogleApi implements FusedLocationProviderClient {
    ...
    public final Task flushLocations() {
        return this.doWrite(TaskApiCall.builder().run((zzca this, Object object0) -> ((zzdz)object0).zzB(((TaskCompletionSource)object1))).setMethodKey(0x976).build());
    }

    @Override  // com.google.android.gms.common.api.GoogleApi
    protected final String getApiFallbackAttributionTag(Context context0) {
        return null;
    }
    ...
    public final Task getLastLocation() {
        return this.doRead(TaskApiCall.builder().run((zzby this, Object object1) -> ((zzdz)object0).zzq(new com.google.android.gms.location.LastLocationRequest.Builder().build(), ((TaskCompletionSource)object1))).setMethodKey(0x96E).build());
    }
    ...
    public final Task removeDeviceOrientationUpdates(DeviceOrientationListener deviceOrientationListener0) {
        return this.doUnregisterEventListener(ListenerHolders.createListenerKey(deviceOrientationListener0, "DeviceOrientationListener"), 2440).continueWith((zzcg this) -> runnable0.run(), (Task task0) -> null);
    }
    ...
    public final Task removeLocationUpdates(LocationCallback locationCallback0) {
        return this.doUnregisterEventListener(ListenerHolders.createListenerKey(locationCallback0, "LocationCallback"), 0x972).continueWith((zzce this) -> runnable0.run(), (Task task0) -> null);
    }

    // 去混淆评级： 低(20)
    @Override  // com.google.android.gms.location.FusedLocationProviderClient
    public final Task removeLocationUpdates(LocationListener locationListener0) {
        return this.doUnregisterEventListener(ListenerHolders.createListenerKey(locationListener0, "LocationListener"), 0x972).continueWith((zzch this) -> runnable0.run(), (Task task0) -> null);
    }
    ...
    public final Task setMockMode(boolean z) {
        synchronized(zzbi.zzc) {
            if(!z) {
                ...
                if(object2 != null) {
                    zzbi.zzd = null;
                    return this.doUnregisterEventListener(ListenerHolders.createListenerKey(object2, "Object"), 2420).continueWith((zzcf this) -> runnable0.run(), (Task task0) -> null);
                }
            }
            else if(zzbi.zzd == null) {
                Object object1 = new Object();
                zzbi.zzd = object1;
                return this.doRegisterEventListener(RegistrationMethods.builder().register((zzcb this, Object object0) -> ((zzdz)object0).zzy(((TaskCompletionSource)object1))).unregister((zzcc this, Object object0) -> ((zzdz)object0).zzz(((TaskCompletionSource)object1))).withHolder(ListenerHolders.createListenerHolder(object1, Looper.getMainLooper(), "Object")).setMethodKey(2420).build());
            }
        }
    ...
    private final Task zza(LocationRequest locationRequest0, ListenerHolder listenerHolder0) {
        zzbh zzbh0 = new zzbh(this, listenerHolder0, (zzcd this, zzdz zzdz0, ListenerKey listenerHolder$ListenerKey0, boolean z) -> zzdz0.zzv(listenerHolder$ListenerKey0, z, taskCompletionSource0));
    ...
    private final Task zzb(LocationRequest locationRequest0, ListenerHolder listenerHolder0) {
        zzbh zzbh0 = new zzbh(this, listenerHolder0, (zzbz this, zzdz zzdz0, ListenerKey listenerHolder$ListenerKey0, boolean z) -> zzdz0.zzw(listenerHolder$ListenerKey0, z, taskCompletionSource0));
