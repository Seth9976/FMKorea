...
final class zzgux extends zzguw {
    ...
    @Override  // com.google.android.gms.internal.ads.zzguw
    final String zzb(byte[] arr_b, int v, int v1) {
        ...
        while(v < v2) {
            ...
            if(zzguv.zzf(((byte)v7))) {
                if(v6 < v2) {
                    v += 2;
                    zzguv.zzc(((byte)v7), arr_b[v6], arr_c, v5);
                    ++v5;
                    continue;
                }
            }
                ...
                if(v6 < v2 - 2) {
                    ...
                    int v12 = arr_b[v + 2];
                    v += 4;
                    zzguv.zza(((byte)v7), ((byte)v10), ((byte)v12), arr_b[v11], arr_c, v5);
                    v5 += 2;
                    continue;
                }
            }
                ...
                int v9 = v + 2;
                v += 3;
                zzguv.zzb(((byte)v7), arr_b[v6], arr_b[v9], arr_c, v5);
                ++v5;
                continue;
            }
            throw zzgsc.zzd();
