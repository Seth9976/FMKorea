...
public abstract class zzbot extends zzatw implements zzbou {
    ...
    public static zzbou zzb(IBinder iBinder0) {
        if(iBinder0 == null) {
            return null;
        }
        ...
        return iInterface0 instanceof zzbou ? ((zzbou)iInterface0) : new zzbos(iBinder0);
    }
    ...
    protected final boolean zzbJ(int v, Parcel parcel0, Parcel parcel1, int v1) {
        switch(v) {
            ...
            case 15: {
                ...
                parcel1.writeNoException();
                zzatx.zzf(parcel1, iObjectWrapper2);
                return true;
            }
            case 16: {
