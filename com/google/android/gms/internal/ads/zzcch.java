...
public final class zzcch extends Thread implements SurfaceTexture.OnFrameAvailableListener, zzccf {
    ...
    static {
        zzcch.zza = new float[]{-1.0f, -1.0f, -1.0f, 1.0f, -1.0f, -1.0f, -1.0f, 1.0f, -1.0f, 1.0f, 1.0f, -1.0f};
    }

    public zzcch(Context context0) {
        ...
        floatBuffer0.put(zzcch.zza).position(0);
        ...
        this.zzj = NaNf;
        zzccg zzccg0 = new zzccg(context0);
        this.zzb = zzccg0;
        zzccg0.zza(this);
    ...
    public final void run() {
        ...
        if(this.zzp != null) {
            ...
            if(z && this.zzq != 0) {
                    ...
                    try {
                        try {
                            ...
                            if(this.zzb.zzd(this.zzc)) {
                                ...
                                zzcch.zzk(this.zzh, this.zzj + this.zzk);
                            }
                            else {
                                zzcch.zzj(this.zzc, -1.570796f);
                                zzcch.zzk(this.zzh, this.zzk);
                            }
                            zzcch.zzj(this.zzd, 1.570796f);
                            zzcch.zzi(this.zze, this.zzh, this.zzd);
                            zzcch.zzi(this.zzf, this.zzc, this.zze);
                            zzcch.zzj(this.zzg, this.zzl);
                            zzcch.zzi(this.zzi, this.zzg, this.zzf);
                            GLES20.glUniformMatrix3fv(this.zzr, 1, false, this.zzi, 0);
                            GLES20.glDrawArrays(5, 0, 4);
                            zzcch.zzh("drawArrays");
                            GLES20.glFinish();
                ...
                label_148:
                    zzcaa.zzj("SphericalVideoProcessor halted unexpectedly.");
                    return;
                label_151:
                    zzcaa.zzh("SphericalVideoProcessor died.", throwable0);
                    zzt.zzo().zzu(throwable0, "SphericalVideoProcessor.run.2");
                    return;
                }
                return;
            }
            ...
            zzcaa.zzg(s);
            zzt.zzo().zzu(new Throwable(s), "SphericalVideoProcessor.run.1");
            this.zzg();
            this.zzu.countDown();
            return;
        }
        zzcaa.zzg("SphericalVideoProcessor started with no output texture.");
        this.zzu.countDown();
    }
    ...
    public final void zzf(float f, float f1) {
        float f2 = this.zzn <= this.zzm ? ((float)this.zzm) : ((float)this.zzn);
        this.zzk -= f * 1.745329f / f2;
        float f3 = this.zzl - f1 * 1.745329f / f2;
        this.zzl = f3;
        if(f3 < -1.570796f) {
            this.zzl = -1.570796f;
            f3 = -1.570796f;
