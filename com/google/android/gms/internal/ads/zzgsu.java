...
public final class zzgsu extends LinkedHashMap {
    private static final zzgsu zza;
    private boolean zzb;

    static {
        zzgsu zzgsu0 = new zzgsu();
        zzgsu.zza = zzgsu0;
        zzgsu0.zzb = false;
    }
    ...
    public final int hashCode() {
        ...
        for(Object object0: this.entrySet()) {
            int v1 = zzgsu.zzf(((Map.Entry)object0).getKey());
            v += zzgsu.zzf(((Map.Entry)object0).getValue()) ^ v1;
        }
        return v;
    }
    ...
    public static zzgsu zza() {
        return zzgsu.zza;
    }

    // 去混淆评级： 低(20)
    public final zzgsu zzb() {
        return this.isEmpty() ? new zzgsu() : new zzgsu(this);
    }
    ...
    public final void zzd(zzgsu zzgsu0) {
        this.zzg();
        if(!zzgsu0.isEmpty()) {
            this.putAll(zzgsu0);
        }
    ...
    private static int zzf(Object object0) {
        if(object0 instanceof byte[]) {
            ...
            int v1 = zzgsa.zzb(v, ((byte[])object0), 0, v);
            return v1 == 0 ? 1 : v1;
        }
        if(object0 instanceof zzgrs) {
