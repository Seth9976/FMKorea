...
final class zzgtc {
    ...
    static String zza(zzgta zzgta0, String s) {
        StringBuilder stringBuilder0 = new StringBuilder();
        stringBuilder0.append("# ");
        stringBuilder0.append(s);
        zzgtc.zzd(zzgta0, stringBuilder0, 0);
    ...
    static void zzb(StringBuilder stringBuilder0, int v, String s, Object object0) {
        if(object0 instanceof List) {
            for(Object object1: ((List)object0)) {
                zzgtc.zzb(stringBuilder0, v, s, object1);
            }
            return;
        }
        if(object0 instanceof Map) {
            for(Object object2: ((Map)object0).entrySet()) {
                zzgtc.zzb(stringBuilder0, v, s, ((Map.Entry)object2));
            }
            return;
        }
        stringBuilder0.append('\n');
        zzgtc.zzc(v, stringBuilder0);
        if(!s.isEmpty()) {
        ...
        if(object0 instanceof String) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(zzgui.zza(zzgqi.zzw(((String)object0))));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzgqi) {
            stringBuilder0.append(": \"");
            stringBuilder0.append(zzgui.zza(((zzgqi)object0)));
            stringBuilder0.append('\"');
            return;
        }
        if(object0 instanceof zzgrq) {
            stringBuilder0.append(" {");
            zzgtc.zzd(((zzgrq)object0), stringBuilder0, v + 2);
            stringBuilder0.append("\n");
            zzgtc.zzc(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
        ...
        if(object0 instanceof Map.Entry) {
            stringBuilder0.append(" {");
            zzgtc.zzb(stringBuilder0, v + 2, "key", ((Map.Entry)object0).getKey());
            zzgtc.zzb(stringBuilder0, v + 2, "value", ((Map.Entry)object0).getValue());
            stringBuilder0.append("\n");
            zzgtc.zzc(v, stringBuilder0);
            stringBuilder0.append("}");
            return;
    ...
    private static void zzc(int v, StringBuilder stringBuilder0) {
        while(true) {
            ...
            stringBuilder0.append(zzgtc.zza, 0, v1);
            v -= v1;
        }
    }

    private static void zzd(zzgta zzgta0, StringBuilder stringBuilder0, int v) {
        boolean z;
        HashSet hashSet0 = new HashSet();
        HashMap hashMap0 = new HashMap();
        TreeMap treeMap0 = new TreeMap();
        Method[] arr_method = zzgta0.getClass().getDeclaredMethods();
        ...
        for(Object object0: treeMap0.entrySet()) {
            ...
            if(s.endsWith("List") && !s.endsWith("OrBuilderList") && !s.equals("List")) {
                ...
                if(method1 != null && method1.getReturnType().equals(List.class)) {
                    zzgtc.zzb(stringBuilder0, v, s.substring(0, s.length() - 4), zzgrq.zzaQ(method1, zzgta0, new Object[0]));
                    continue;
                }
            }
            if(s.endsWith("Map") && !s.equals("Map")) {
                ...
                if(method2 != null && method2.getReturnType().equals(Map.class) && !method2.isAnnotationPresent(Deprecated.class) && Modifier.isPublic(method2.getModifiers())) {
                    zzgtc.zzb(stringBuilder0, v, s.substring(0, s.length() - 3), zzgrq.zzaQ(method2, zzgta0, new Object[0]));
                    continue;
                }
            }
            if(hashSet0.contains("set" + s) && (!s.endsWith("Bytes") || !treeMap0.containsKey("get" + s.substring(0, s.length() - 5)))) {
                ...
                if(method3 != null) {
                    Object object1 = zzgrq.zzaQ(method3, zzgta0, new Object[0]);
                    if(method4 == null) {
                        if(object1 instanceof Boolean) {
                            ...
                            if(object1 instanceof zzgqi) {
                                z = object1.equals(zzgqi.zzb);
                            label_57:
                                if(z) {
                                    continue;
                                }
                            }
                            else if(object1 instanceof zzgta) {
                                if(object1 == ((zzgta)object1).zzbf()) {
                                    continue;
                                }
                            }
                    ...
                    label_64:
                        if(((Boolean)zzgrq.zzaQ(method4, zzgta0, new Object[0])).booleanValue()) {
                            goto label_65;
                        }
                        continue;
                    }
        ...
        if(!(zzgta0 instanceof zzgrn)) {
            zzgul zzgul0 = ((zzgrq)zzgta0).zzc;
            if(zzgul0 != null) {
                zzgul0.zzi(stringBuilder0, v);
            }
            return;
        }
        zzgrn zzgrn0 = (zzgrn)zzgta0;
        throw null;
    }
}
