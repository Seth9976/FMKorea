...
public final class zzvm {
    ...
    private zzvm(int v, Random random0) {
        this(new int[0], random0);
    }

    private zzvm(int[] arr_v, Random random0) {
        this.zzb = arr_v;
        this.zza = random0;
    ...
    public final zzvm zzg(int v, int v1) {
        ...
        return new zzvm(arr_v2, new Random(this.zza.nextLong()));
    }

    public final zzvm zzh(int v, int v1) {
        ...
        return new zzvm(arr_v, new Random(this.zza.nextLong()));
    }
}
