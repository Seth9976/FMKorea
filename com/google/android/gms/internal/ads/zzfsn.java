...
final class zzfsn extends zzfsq implements NavigableMap {
    final zzfsw zzc;

    zzfsn(zzfsw zzfsw0, NavigableMap navigableMap0) {
        this.zzc = zzfsw0;
    ...
    public final NavigableSet descendingKeySet() {
        return (NavigableSet)((zzfsq)this.descendingMap()).super.zzh();
    }

    @Override
    public final NavigableMap descendingMap() {
        NavigableMap navigableMap0 = ((NavigableMap)(((SortedMap)this.zza))).descendingMap();
        return new zzfsn(this.zzc, navigableMap0);
    }
    ...
    final Map.Entry zzc(Iterator iterator0) {
        ...
        iterator0.remove();
        return new zzftz(((Map.Entry)object0).getKey(), this.zzc.zzb(collection0));
    }

    final NavigableSet zzd() {
        return new zzfso(this.zzc, ((NavigableMap)(((SortedMap)this.zza))));
    }
