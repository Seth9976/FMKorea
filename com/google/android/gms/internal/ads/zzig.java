...
public final class zzig {
    ...
    zzig(float f, float f1, long v, float f2, long v1, long v2, float f3, zzif zzif0) {
        this.zza = v1;
        this.zzb = v2;
    ...
    public final float zza(long v, long v1) {
        long v6;
        float f = 1.0f;
        if(Long.compare(this.zzc, 0x8000000000000001L) != 0) {
            long v2 = v - v1;
            long v3 = this.zzm;
            if(v3 == 0x8000000000000001L) {
                ...
                long v4 = Math.max(v2, zzig.zzf(v3, v2, 0.999f));
                this.zzm = v4;
                this.zzn = zzig.zzf(this.zzn, Math.abs(v2 - v4), 0.999f);
            }
            if(Long.compare(this.zzl, 0x8000000000000001L) != 0 && SystemClock.elapsedRealtime() - this.zzl < 1000L) {
                return this.zzk;
            }
            this.zzl = SystemClock.elapsedRealtime();
            long v5 = this.zzm + this.zzn * 3L;
            if(Long.compare(this.zzh, v5) > 0) {
                ...
                long v9 = Math.max(this.zzh, Math.min(v - ((long)(Math.max(0.0f, this.zzk - 1.0f) / 1.000000E-07f)), v5));
                this.zzh = v9;
                long v10 = this.zzg;
            ...
            long v11 = v - v6;
            if(Math.abs(v11) < this.zza) {
                this.zzk = 1.0f;
                return 1.0f;
            }
            f = Math.max(this.zzj, Math.min(((float)v11) * 1.000000E-07f + 1.0f, this.zzi));
            this.zzk = f;
        }
        return f;
    }
