...
public final class zzfme {
    ...
    public static final int zzb(Context context0, zzflc zzflc0) {
        String s;
        int v;
        File file0 = new File(new File(context0.getApplicationInfo().dataDir), "lib");
        if(file0.exists()) {
            File[] arr_file = file0.listFiles(new zzfwh(Pattern.compile(".*\\.so$", 2)));
            if(arr_file == null || arr_file.length == 0) {
                zzflc0.zzb(5017, "No .so");
            label_42:
                String s1 = zzfme.zzc(context0, zzflc0);
                if(TextUtils.isEmpty(s1)) {
                    zzfme.zzd(null, "Empty dev arch", context0, zzflc0);
                    v = 1;
                    s = "UNSUPPORTED";
                }
                    ...
                    zzfme.zzd(null, s1, context0, zzflc0);
                    v = 1;
                    s = "UNSUPPORTED";
                }
                else {
                ...
                try(FileInputStream fileInputStream0 = new FileInputStream(arr_file[0])) {
                    ...
                    if(fileInputStream0.read(arr_b) == 20) {
                        byte[] arr_b1 = {0, 0};
                        if(arr_b[5] == 2) {
                            zzfme.zzd(arr_b, null, context0, zzflc0);
                            goto label_38;
                        }
                        else {
                            arr_b1[0] = arr_b[19];
                    ...
                    zzfme.zzd(null, iOException0.toString(), context0, zzflc0);
                }
            label_38:
                v = 1;
                s = "UNSUPPORTED";
    ...
    private static final String zzc(Context context0, zzflc zzflc0) {
        ...
        if(arr_s != null && arr_s.length > 0) {
            try {
                ...
                zzflc0.zzc(2024, 0L, noSuchFieldException0);
                return "arm64-v8a";
            }
            catch(IllegalAccessException illegalAccessException0) {
                zzflc0.zzc(2024, 0L, illegalAccessException0);
                return "arm64-v8a";
            }
        }
        return "arm64-v8a";
    ...
    private static final void zzd(byte[] arr_b, String s, Context context0, zzflc zzflc0) {
        ...
        zzflc0.zzb(4007, stringBuilder0.toString());
    }
}
