...
public final class zzcbn extends zzcbp implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, TextureView.SurfaceTextureListener {
    ...
    public zzcbn(Context context0, zzccj zzccj0, boolean z, boolean z1, zzcci zzcci0, zzcck zzcck0) {
        super(context0);
        this.zzg = 0;
        this.zzh = 0;
        this.zzr = false;
    ...
    public final void onCompletion(MediaPlayer mediaPlayer0) {
        ...
        this.zzF(5);
        this.zzh = 5;
        zzcbg zzcbg0 = new zzcbg(this);
        zzs.zza.post(zzcbg0);
    }

    @Override  // android.media.MediaPlayer$OnErrorListener
    public final boolean onError(MediaPlayer mediaPlayer0, int v, int v1) {
        String s = (String)zzcbn.zzc.get(v);
        String s1 = (String)zzcbn.zzc.get(v1);
        zzcaa.zzj(("AdMediaPlayerView MediaPlayer error: " + s + ":" + s1));
        this.zzF(-1);
        this.zzh = -1;
        zzcbh zzcbh0 = new zzcbh(this, s, s1);
        zzs.zza.post(zzcbh0);
        return true;
    }
    ...
    public final boolean onInfo(MediaPlayer mediaPlayer0, int v, int v1) {
        zze.zza(("AdMediaPlayerView MediaPlayer info: " + ((String)zzcbn.zzc.get(v)) + ":" + ((String)zzcbn.zzc.get(v1))));
        return true;
    }
    ...
    public final void onPrepared(MediaPlayer mediaPlayer0) {
        ...
        this.zzF(2);
        this.zze.zzb();
        zzcbf zzcbf0 = new zzcbf(this, mediaPlayer0);
        zzs.zza.post(zzcbf0);
        ...
        if(this.zzf && this.zzH() && this.zzi.getCurrentPosition() > 0 && this.zzh != 3) {
            ...
            while(this.zzH() && this.zzi.getCurrentPosition() == v1 && zzt.zzB().currentTimeMillis() - v2 <= 0xFAL) {
            }
            this.zzi.pause();
            this.zzn();
        }
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture0, int v, int v1) {
        ...
        zzcbj zzcbj0 = new zzcbj(this, v, v1);
        zzs.zza.post(zzcbj0);
    }
    ...
    public final String toString() {
        return "com.google.android.gms.internal.ads.zzcbn@" + Integer.toHexString(this.hashCode());
    }
        ...
        if(this.zzj != null && surfaceTexture0 != null) {
            ...
            try {
                ...
                if(this.zzo) {
                    ...
                    this.zzn = zzcch0;
                    zzcch0.zzd(surfaceTexture0, this.getWidth(), this.getHeight());
                    this.zzn.start();
            ...
            zzcaa.zzk(("Failed to initialize MediaPlayer at " + this.zzj), iOException0);
    ...
    static void zzk(zzcbn zzcbn0, boolean z) {
        zzcbn0.zzr = true;
    }

    static void zzl(zzcbn zzcbn0, MediaPlayer mediaPlayer0) {
        MediaPlayer.TrackInfo[] arr_mediaPlayer$TrackInfo;
        if(((Boolean)zzba.zzc().zzb(zzbbr.zzbN)).booleanValue() && zzcbn0.zzd != null && mediaPlayer0 != null) {
            try {
                arr_mediaPlayer$TrackInfo = mediaPlayer0.getTrackInfo();
            }
            catch(RuntimeException runtimeException0) {
                zzt.zzo().zzu(runtimeException0, "AdMediaPlayerView.reportMetadata");
                return;
            }
            if(arr_mediaPlayer$TrackInfo != null) {
                ...
                if(!hashMap0.isEmpty()) {
                    zzcbn0.zzd.zzd("onMetadataEvent", hashMap0);
                }
            }
        }
    }
    ...
    public final void zzs(String s) {
        ...
        zzawq zzawq0 = zzawq.zza(uri0);
        if(zzawq0 != null && zzawq0.zza == null) {
            return;
        }
        if(zzawq0 != null) {
            uri0 = Uri.parse(zzawq0.zza);
        }
        this.zzj = uri0;
        this.zzp = 0;
        this.zzD();
    ...
    static boolean zzv(zzcbn zzcbn0) {
        return zzcbn0.zzr;
    }
}
