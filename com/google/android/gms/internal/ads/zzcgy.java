...
public abstract class zzcgy extends zzatw implements zzcgz {
    ...
    protected final boolean zzbJ(int v, Parcel parcel0, Parcel parcel1, int v1) {
        switch(v) {
            ...
            case 7: {
                Bundle bundle4 = (Bundle)zzatx.zza(parcel0, Bundle.CREATOR);
                zzatx.zzc(parcel0);
                this.zzq(bundle4);
                parcel1.writeNoException();
                return true;
            ...
            case 8: {
                ...
                Bundle bundle5 = (Bundle)zzatx.zza(parcel0, Bundle.CREATOR);
                zzatx.zzc(parcel0);
            ...
            case 19: {
                Bundle bundle6 = (Bundle)zzatx.zza(parcel0, Bundle.CREATOR);
                zzatx.zzc(parcel0);
                this.zzr(bundle6);
                parcel1.writeNoException();
                return true;
