...
public final class zzgzh {
    ...
    public static String zza(Context context0) {
        ...
        if(arrayList0.size() == 1) {
            zzgzh.zza = (String)arrayList0.get(0);
            return zzgzh.zza;
        }
