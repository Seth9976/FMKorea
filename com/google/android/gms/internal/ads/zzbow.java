...
public final class zzbow implements MediationAppOpenAdCallback, MediationBannerAdCallback, MediationInterstitialAdCallback, MediationNativeAdCallback {
    private final zzbol zza;

    public zzbow(zzbol zzbol0) {
        this.zza = zzbol0;
    }
    ...
    public final void onAdFailedToShow(AdError adError0) {
        ...
        zzcaa.zzj(("Mediation ad failed to show: Error Code = " + adError0.getCode() + ". Error Message = " + adError0.getMessage() + " Error Domain = " + adError0.getDomain()));
        try {
    ...
    public final void onAdFailedToShow(String s) {
        Preconditions.checkMainThread("#008 Must be called on the main UI thread.");
        zzcaa.zze("Adapter called onAdFailedToShow.");
        zzcaa.zzj(("Mediation ad failed to show: " + s));
        try {
            this.zza.zzl(s);
        }
        catch(RemoteException remoteException0) {
