...
public final class zzbkd extends AbstractSafeParcelable {
    ...
    static {
        zzbkd.CREATOR = new zzbke();
    }

    @Constructor
    zzbkd(@Param(id = 1) boolean z, @Param(id = 2) String s, @Param(id = 3) int v, @Param(id = 4) byte[] arr_b, @Param(id = 5) String[] arr_s, @Param(id = 6) String[] arr_s1, @Param(id = 7) boolean z1, @Param(id = 8) long v1) {
        this.zza = z;
        this.zzb = s;
        this.zzc = v;
        this.zzd = arr_b;
