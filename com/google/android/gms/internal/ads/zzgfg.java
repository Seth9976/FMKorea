...
public final class zzgfg {
    public static byte[] zza(byte[] arr_b, byte[] arr_b1) {
        long v = zzgfg.zzb(arr_b, 0, 0);
        long v1 = zzgfg.zzb(arr_b, 3, 2);
        long v2 = zzgfg.zzb(arr_b, 6, 4);
        long v3 = zzgfg.zzb(arr_b, 9, 6);
        long v4 = zzgfg.zzb(arr_b, 12, 8);
        ...
        long v9 = 0L;
        long v10;
        for(v10 = 0L; v6 < arr_b1.length; v10 = v25 & 0x3FFFFFFL) {
            int v11 = Math.min(16, arr_b1.length - v6);
            System.arraycopy(arr_b1, v6, arr_b2, 0, v11);
            arr_b2[v11] = 1;
            if(v11 != 16) {
            ...
            long v15 = v10 + zzgfg.zzb(arr_b2, 0, 0);
            long v16 = v7 + zzgfg.zzb(arr_b2, 3, 2);
            long v17 = v5 + zzgfg.zzb(arr_b2, 6, 4);
            long v18 = v8 + zzgfg.zzb(arr_b2, 9, 6);
            long v19 = v9 + (zzgfg.zzb(arr_b2, 12, 8) | ((long)(arr_b2[16] << 24)));
        ...
        long v27 = v8 + (v26 >> 26);
        long v28 = v9 + (v27 >> 26);
        long v29 = v10 + (v28 >> 26) * 5L;
        long v30 = (v29 & 0x3FFFFFFL) + 5L;
        long v31 = (v7 & 0x3FFFFFFL) + (v29 >> 26);
        ...
        long v37 = ((v34 >> 0x3F & (v29 & 0x3FFFFFFL) | v30 & 0x3FFFFFFL & ~(v34 >> 0x3F) | v31 << 26) & 0xFFFFFFFFL) + zzgfg.zzc(arr_b, 16);
        long v38 = zzgfg.zzc(arr_b, 20);
        long v39 = zzgfg.zzc(arr_b, 24);
        long v40 = zzgfg.zzc(arr_b, 28);
        byte[] arr_b3 = new byte[16];
        zzgfg.zzd(arr_b3, v37 & 0xFFFFFFFFL, 0);
        long v41 = ((v31 >> 6 | v35 << 20) & 0xFFFFFFFFL) + v38 + (v37 >> 0x20);
        zzgfg.zzd(arr_b3, v41 & 0xFFFFFFFFL, 4);
        long v42 = ((v35 >> 12 | v36 << 14) & 0xFFFFFFFFL) + v39 + (v41 >> 0x20);
        zzgfg.zzd(arr_b3, v42 & 0xFFFFFFFFL, 8);
        zzgfg.zzd(arr_b3, ((v36 >> 18 | (v28 & 0x3FFFFFFL & v34 >> 0x3F | v34 & ~(v34 >> 0x3F)) << 8) & 0xFFFFFFFFL) + v40 + (v42 >> 0x20) & 0xFFFFFFFFL, 12);
        return arr_b3;
    }

    private static long zzb(byte[] arr_b, int v, int v1) {
        return zzgfg.zzc(arr_b, v) >> v1 & 0x3FFFFFFL;
    }
