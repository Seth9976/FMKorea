...
public final class zzael extends zzaes {
    ...
    static {
        zzael.CREATOR = new zzaek();
    }

    zzael(Parcel parcel0) {
        super("COMM");
    ...
    public zzael(String s, String s1, String s2) {
        super("COMM");
        this.zza = s;
        this.zzb = s1;
        this.zzc = s2;
    ...
    public final boolean equals(Object object0) {
        ...
        if(object0 != null) {
            ...
            return zzael.class == class0 && zzfk.zzD(this.zzb, ((zzael)object0).zzb) && zzfk.zzD(this.zza, ((zzael)object0).zza) && zzfk.zzD(this.zzc, ((zzael)object0).zzc);
        }
        return false;
    }
