...
public final class zzawn extends AbstractSafeParcelable {
    ...
    @Constructor
    public zzawn(@Param(id = 2) ParcelFileDescriptor parcelFileDescriptor0, @Param(id = 3) boolean z, @Param(id = 4) boolean z1, @Param(id = 5) long v, @Param(id = 6) boolean z2) {
