...
final class zzbqp implements MediationAppOpenAdCallback, MediationBannerAdCallback, MediationInterstitialAdCallback, MediationNativeAdCallback, MediationRewardedAdCallback {
    final zzbol zza;
    ...
    public final void onAdFailedToShow(AdError adError0) {
        try {
            zzcaa.zzj(("Mediated ad failed to show: Error Code = " + adError0.getCode() + ". Error Message = " + adError0.getMessage() + " Error Domain = " + adError0.getDomain()));
    ...
    public final void onAdFailedToShow(String s) {
        try {
            zzcaa.zzj(("Mediated ad failed to show: " + s));
            this.zza.zzl(s);
        }
        catch(RemoteException unused_ex) {
        }
    ...
    public final void onUserEarnedReward(RewardItem rewardItem0) {
        try {
            zzbwn zzbwn0 = new zzbwn(rewardItem0);
            this.zza.zzt(zzbwn0);
        }
        catch(RemoteException unused_ex) {
        }
