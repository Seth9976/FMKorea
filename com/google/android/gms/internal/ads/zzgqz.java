...
final class zzgqz extends zzgps implements zzgrz, zzgth, RandomAccess {
    private static final zzgqz zza;
    private double[] zzb;
    private int zzc;

    static {
        zzgqz.zza = new zzgqz(new double[0], 0, false);
    }
    ...
    private zzgqz(double[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzgqz)) {
            return super.addAll(collection0);
        }
        int v = ((zzgqz)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzgqz)collection0).zzb, 0, this.zzb, this.zzc, ((zzgqz)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzgqz)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzgqz)object0).zzc) {
            return false;
        }
        double[] arr_f = ((zzgqz)object0).zzb;
    ...
    public final zzgrz zzd(int v) {
        ...
        return new zzgqz(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
