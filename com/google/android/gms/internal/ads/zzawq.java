...
public final class zzawq extends AbstractSafeParcelable {
    ...
    static {
        zzawq.CREATOR = new zzawr();
    }

    @Constructor
    zzawq(@Param(id = 2) String s, @Param(id = 3) long v, @Param(id = 4) String s1, @Param(id = 5) String s2, @Param(id = 6) String s3, @Param(id = 7) Bundle bundle0, @Param(id = 8) boolean z, @Param(id = 9) long v1, @Param(id = 10) String s4, @Param(id = 11) int v2) {
        this.zza = s;
        this.zzb = v;
        if(s1 == null) {
            s1 = "";
    ...
    public static zzawq zza(Uri uri0) {
        try {
            ...
            if(list0.size() != 2) {
                zzcaa.zzj(("Expected 2 path parts for namespace and id, found :" + list0.size()));
                return null;
            }
            ...
            return new zzawq(s1, v, s, ((String)object0), ((String)object1), bundle0, z, 0L, "", 0);
        }
        catch(NullPointerException | NumberFormatException nullPointerException0) {
        }
        zzcaa.zzk("Unable to parse Uri into cache offering.", nullPointerException0);
        return null;
    }
}
