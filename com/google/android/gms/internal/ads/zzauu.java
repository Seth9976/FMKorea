...
public final class zzauu {
    ...
    public zzauu(int v, int v1, int v2, int v3, int v4, int v5, int v6, boolean z) {
        this.zzg = new Object();
        ...
        this.zzc = v2;
        this.zzd = z;
        this.zze = new zzavj(v3);
        this.zzf = new zzavr(v4, v5, v6);
    }

    @Override
    public final boolean equals(Object object0) {
        if(!(object0 instanceof zzauu)) {
            return false;
        }
        if(object0 == this) {
            return true;
        }
        String s = ((zzauu)object0).zzo;
    ...
    private final void zzp(String s, boolean z, float f, float f1, float f2, float f3) {
        if(s != null && s.length() >= this.zzc) {
            ...
            synchronized(object0) {
                ...
                if(z) {
                    this.zzi.add(s);
                    zzavf zzavf0 = new zzavf(f, f1, f2, f3, this.zzi.size() - 1);
                    this.zzj.add(zzavf0);
                }
            }
        }
    ...
    private static final String zzq(ArrayList arrayList0, int v) {
