...
public final class zzaqx {
    ...
    static {
        zzaqx.zza = new String[]{"/aclk", "/pcs/click", "/dbm/clk"};
    }

    @Deprecated
    public zzaqx(zzaqt zzaqt0) {
    ...
    @Deprecated
    public final Uri zza(Uri uri0, Context context0, View view0, Activity activity0) {
        try {
            String s = uri0.getQueryParameter("ai");
            return this.zzg(uri0, this.zzd.zzf(context0, s, view0, activity0));
        }
    ...
    @Deprecated
    public final Uri zzb(Uri uri0, Context context0) {
        return this.zzg(uri0, this.zzd.zzg(context0));
    }
    ...
    private final Uri zzg(Uri uri0, String s) {
        if(uri0 == null) {
            throw null;
        }
        else {
