...
public final class zzbjb {
    public static final Intent zza(Uri uri0, Context context0, zzaqx zzaqx0, View view0) {
        if(uri0 == null) {
            return null;
        }
    ...
    public static final Intent zzb(Intent intent0, ResolveInfo resolveInfo0, Context context0, zzaqx zzaqx0, View view0) {
    ...
    public static final ResolveInfo zzc(Intent intent0, Context context0, zzaqx zzaqx0, View view0) {
        return zzbjb.zzd(intent0, new ArrayList(), context0, zzaqx0, view0);
    }

    public static final ResolveInfo zzd(Intent intent0, ArrayList arrayList0, Context context0, zzaqx zzaqx0, View view0) {
        ...
        try {
            ...
            zzt.zzo().zzu(throwable0, "OpenSystemBrowserHandler.getDefaultBrowserResolverForIntent");
        }
        return resolveInfo0;
    }
}
