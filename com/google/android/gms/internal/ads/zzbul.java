...
public final class zzbul extends AbstractSafeParcelable {
    ...
    static {
        zzbul.CREATOR = new zzbum();
    }

    @Constructor
    public zzbul(@Param(id = 2) ParcelFileDescriptor parcelFileDescriptor0) {
    ...
    public final void writeToParcel(Parcel parcel0, int v) {
        ...
        if(this.zza == null) {
            ...
            try {
                ...
                zzbuk zzbuk0 = new zzbuk(parcelFileDescriptor$AutoCloseOutputStream0, arr_b);
                zzcan.zza.execute(zzbuk0);
                parcelFileDescriptor0 = arr_parcelFileDescriptor[0];
            }
            catch(IOException iOException0) {
                zzcaa.zzh("Error transporting the ad response", iOException0);
                zzt.zzo().zzu(iOException0, "LargeParcelTeleporter.pipeData.2");
    ...
    public final SafeParcelable zza(Parcelable.Creator parcelable$Creator0) {
        ...
        if(this.zzc) {
            if(this.zza == null) {
                zzcaa.zzg("File descriptor is empty, returning null.");
                return null;
            }
            ...
            try {
                ...
                zzcaa.zzh("Could not read from parcel file descriptor", iOException0);
                return null;
            }
            finally {
