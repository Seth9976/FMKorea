...
public final class zzfjz {
    ...
    static {
        zzfjz.zzc = new String[]{"x", "y", "width", "height"};
        zzfjz.zza = Resources.getSystem().getDisplayMetrics().density;
    }

    public static JSONObject zza(int v, int v1, int v2, int v3) {
        JSONObject jSONObject0 = new JSONObject();
        try {
            jSONObject0.put("x", ((double)(((float)v) / zzfjz.zza)));
            jSONObject0.put("y", ((double)(((float)v1) / zzfjz.zza)));
            jSONObject0.put("width", ((double)(((float)v2) / zzfjz.zza)));
            jSONObject0.put("height", ((double)(((float)v3) / zzfjz.zza)));
        }
        catch(JSONException jSONException0) {
            zzfka.zza("Error with creating viewStateObject", jSONException0);
        }
        return jSONObject0;
    }
    ...
    public static void zzb(JSONObject jSONObject0, String s) {
        try {
            ...
            zzfka.zza("Error with setting ad session id", jSONException0);
        }
    }
    ...
    public static void zzd(Context context0) {
        if(context0 != null) {
            zzfjz.zza = context0.getResources().getDisplayMetrics().density;
            zzfjz.zzb = (WindowManager)context0.getSystemService("window");
        }
    }
    ...
    public static void zze(JSONObject jSONObject0, String s, Object object0) {
        try {
            ...
            zzfka.zza(("JSONException during JSONObject.put for name [" + s + "]"), nullPointerException0);
        }
    }
    ...
    public static void zzf(JSONObject jSONObject0) {
        ...
        if(zzfjz.zzb == null) {
            ...
            zzfjz.zzb.getDefaultDisplay().getRealSize(point0);
            float f = zzfjz.zza;
            f1 = ((float)point0.x) / f;
            f2 = ((float)point0.y) / f;
        }
    ...
    public static boolean zzg(JSONObject jSONObject0, JSONObject jSONObject1) {
        if(jSONObject0 == null && jSONObject1 == null) {
            return true;
        }
        if(jSONObject0 != null && jSONObject1 != null) {
            String[] arr_s = zzfjz.zzc;
            for(int v = 0; v < 4; ++v) {
                String s = arr_s[v];
            ...
            if(jSONObject0.optString("adSessionId", "").equals(jSONObject1.optString("adSessionId", "")) && Boolean.valueOf(jSONObject0.optBoolean("noOutputDevice")).equals(Boolean.valueOf(jSONObject1.optBoolean("noOutputDevice"))) && Boolean.valueOf(jSONObject0.optBoolean("hasWindowFocus")).equals(Boolean.valueOf(jSONObject1.optBoolean("hasWindowFocus")))) {
                ...
                label_20:
                    ...
                    if(zzfjz.zzh(jSONArray2, jSONArray3)) {
                        for(int v2 = 0; v2 < jSONArray2.length(); ++v2) {
                            if(!zzfjz.zzg(jSONArray2.optJSONObject(v2), jSONArray3.optJSONObject(v2))) {
                                return false;
                            }
                        }
                        return true;
                ...
                else if(zzfjz.zzh(jSONArray0, jSONArray1)) {
                    int v1 = 0;
                    while(true) {
