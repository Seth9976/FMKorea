...
public final class zzeid implements zzedn {
    ...
    public zzeid(Context context0, zzcag zzcag0, zzfca zzfca0, Executor executor0, zzdnv zzdnv0, zzdom zzdom0, zzbit zzbit0, zzecs zzecs0) {
        this.zza = context0;
        this.zzd = zzfca0;
        this.zzc = zzdnv0;
        this.zze = executor0;
    ...
    public final d zza(zzfbr zzfbr0, zzfbe zzfbe0) {
        ...
        d d0 = zzfye.zzn(zzfye.zzh(null), (Object object0) -> {
            ...
            zzdns zzdns0 = new zzdns(new zzeic(this.zza, this.zzb, this.zzd, this.zzf, zzfbe0, zzcas0, zzcfi0, this.zzg, this.zzh, this.zzi), zzcfi0);
            zzdnr zzdnr0 = this.zzc.zze(zzcst0, zzdns0);
            zzcas0.zzc(zzdnr0);
            zzbji.zzb(zzcfi0, zzdnr0.zzg());
            zzdnr0.zzc().zzo(new zzehy(zzcfi0), zzcan.zzf);
            zzdnr0.zzl().zzi(zzcfi0, true, (this.zzh ? this.zzg : null));
            zzdnr0.zzl();
            return zzfye.zzm(zzdol.zzj(zzcfi0, zzfbe0.zzt.zzb, zzfbe0.zzt.zza), new zzehz(this, zzcfi0, zzfbe0, zzdnr0), this.zze);
        }, this.zze);
        d0.addListener(new zzehx(zzdoq0), this.zze);
        return d0;
    }
