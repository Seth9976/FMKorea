...
abstract class zzgfd {
    ...
    abstract zzgfb zza(byte[] arg1, int arg2);

    public final byte[] zzb(ByteBuffer byteBuffer0, byte[] arr_b, byte[] arr_b1) {
        ...
        try {
            ...
            if(!MessageDigest.isEqual(zzgfg.zza(arr_b3, byteBuffer2.array()), arr_b2)) {
