...
public abstract class zzbfp extends zzatw implements zzbfq {
    ...
    public static zzbfq zzb(IBinder iBinder0) {
        if(iBinder0 == null) {
            return null;
        }
        ...
        return iInterface0 instanceof zzbfq ? ((zzbfq)iInterface0) : new zzbfo(iBinder0);
    }
