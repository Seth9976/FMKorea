...
public final class zzbqx extends zzbrf {
    ...
    public zzbqx(zzcfi zzcfi0, Map map0) {
        super(zzcfi0, "createCalendarEvent");
        this.zza = map0;
        this.zzb = zzcfi0.zzi();
    ...
    static Context zza(zzbqx zzbqx0) {
        return zzbqx0.zzb;
    }
    ...
    public final void zzc() {
        ...
        alertDialog$Builder0.setPositiveButton((resources0 == null ? "Accept" : resources0.getString(string.s3)), new zzbqv(this));
        alertDialog$Builder0.setNegativeButton((resources0 == null ? "Decline" : resources0.getString(string.s4)), new zzbqw(this));
