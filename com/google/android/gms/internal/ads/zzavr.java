...
public final class zzavr {
    ...
    public zzavr(int v, int v1, int v2) {
        this.zzb = v;
        if(v1 > 0x40 || v1 < 0) {
            v1 = 0x40;
        }
        this.zzd = v2 <= 0 ? 1 : v2;
        this.zza = new zzavp(v1);
    }

    public final String zza(ArrayList arrayList0, ArrayList arrayList1) {
        Iterator iterator0;
        zzavi zzavi0;
        Collections.sort(arrayList1, new zzavq(this));
        HashSet hashSet0 = new HashSet();
        int v = 0;
        while(v < arrayList1.size()) {
            String[] arr_s = Normalizer.normalize(((CharSequence)arrayList0.get(((zzavf)arrayList1.get(v)).zze())), Normalizer.Form.NFKC).toLowerCase(Locale.US).split("\n");
            if(arr_s.length != 0) {
                int v1 = 0;
                while(v1 < arr_s.length) {
                    ...
                    String[] arr_s1 = zzavk.zzb(s, true);
                    if(arr_s1.length >= this.zzd) {
                        int v3 = 0;
                    label_33:
                        while(v3 < arr_s1.length) {
                            String s2 = "";
                            for(int v4 = 0; v4 < this.zzd; ++v4) {
                                int v5 = v3 + v4;
                                if(v5 >= arr_s1.length) {
                                    break label_33;
                                }
