...
public final class zzfmt extends AbstractSafeParcelable {
    ...
    static {
        zzfmt.CREATOR = new zzfmu();
    }

    @Constructor
    zzfmt(@Param(id = 1) int v, @Param(id = 2) int v1, @Param(id = 5) int v2, @Param(id = 3) String s, @Param(id = 4) String s1) {
        this.zza = v;
        this.zzb = v1;
        this.zzc = s;
        this.zzd = s1;
    ...
    public zzfmt(int v, int v1, String s, String s1) {
        this(1, 1, v1 - 1, s, s1);
    }
