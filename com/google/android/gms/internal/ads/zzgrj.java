...
final class zzgrj extends zzgps implements zzgrz, zzgth, RandomAccess {
    private static final zzgrj zza;
    private float[] zzb;
    private int zzc;

    static {
        zzgrj.zza = new zzgrj(new float[0], 0, false);
    }
    ...
    private zzgrj(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzgrj)) {
            return super.addAll(collection0);
        }
        int v = ((zzgrj)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzgrj)collection0).zzb, 0, this.zzb, this.zzc, ((zzgrj)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzgrj)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzgrj)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zzgrj)object0).zzb;
    ...
    public final zzgrz zzd(int v) {
        ...
        return new zzgrj(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
