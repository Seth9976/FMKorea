...
public final class zzaug implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    static {
        zzaug.zzc = (long)(((Long)zzba.zzc().zzb(zzbbr.zzbj)));
    }

    public zzaug(Context context0, View view0) {
        this.zzk = new zzbz(zzaug.zzc);
        this.zzl = false;
        this.zzm = -1;
        ...
        this.zzh = (KeyguardManager)context0.getSystemService("keyguard");
        if(context1 instanceof Application) {
            this.zze = (Application)context1;
            this.zzj = new zzaus(((Application)context1), this);
        }
    ...
    static void zzb(zzaug zzaug0, int v) {
        zzaug0.zzj(3);
    }

    public final void zzc(zzauf zzauf0) {
        this.zzn.add(zzauf0);
        this.zzj(3);
    }
    ...
    public final void zze(zzauf zzauf0) {
        this.zzn.remove(zzauf0);
    }

    public final void zzf() {
        this.zzk.zza(zzaug.zzc);
    }
    ...
    private final void zzj(int v) {
        ...
        if(view0 == null) {
            ...
            if(((Boolean)zzba.zzc().zzb(zzbbr.zzeJ)).booleanValue()) {
                rect0.left = arr_v1[0];
                rect0.top = arr_v1[1];
            }
            else {
        ...
        if(((Boolean)zzba.zzc().zzb(zzbbr.zzbm)).booleanValue() && view1 != null) {
            try {
                list0 = new ArrayList();
            ...
            zzt.zzo().zzu(exception1, "PositionWatcher.getParentScrollViewRects");
        }
    ...
    label_48:
        ...
        long v3 = zzs.zzt(view1);
        if(!((Boolean)zzba.zzc().zzb(zzbbr.zzjB)).booleanValue()) {
            if(view0 == null || !zzs.zzP(view1, this.zzg, this.zzh) || !z || !z1 || v1 != 0) {
                z2 = false;
            }
            else {
                z2 = true;
        ...
        else if(view0 != null && zzs.zzP(view1, this.zzg, this.zzh) && z && z1 && v3 >= ((long)(((int)(((Integer)zzba.zzc().zzb(zzbbr.zzjE)))))) && v1 == 0) {
            z2 = true;
            v1 = 0;
        }
        else {
        ...
        if(((Boolean)zzba.zzc().zzb(zzbbr.zzjG)).booleanValue()) {
            int v4 = zzs.zzP(view1, this.zzg, this.zzh) ? 0x40 : 0;
            z3 = z1;
            zzs.zzG(view1, (v3 < ((long)(((int)(((Integer)zzba.zzc().zzb(zzbbr.zzjE)))))) ? 0 : 0x20) | ((v1 == 0 ? 0x80 : 0) | (v4 | (z ? 8 : 0) | (z1 ? 16 : 0))) | z2, null);
        }
        else {
            z3 = z1;
        }
        if(v == 1 && !this.zzk.zzb() && z2 == this.zzl) {
            return;
        }
        if(!z2 && !this.zzl && v == 1) {
            return;
        }
        zzaue zzaue0 = new zzaue(zzt.zzB().elapsedRealtime(), this.zzg.isScreenOn(), view1 != null && view1.isAttachedToWindow(), (view1 == null ? 8 : view1.getWindowVisibility()), this.zza(this.zzp), this.zza(rect0), this.zza(rect1), z, this.zza(rect2), z3, v3, this.zza(rect3), this.zzo.density, z2, list0);
        for(Object object0: this.zzn) {
            ((zzauf)object0).zzbt(zzaue0);
        }
        this.zzl = z2;
    }

    private final void zzk() {
        zzauc zzauc0 = () -> this.zzj(3);
        zzs.zza.post(zzauc0);
    }
    ...
    private final void zzl(View view0) {
        ...
        if(this.zza == null) {
            ...
            zzt.zzv().zzc(this.zzd, this.zza, intentFilter0);
        }
        ...
        if(application0 != null) {
            try {
                ...
                zzcaa.zzh("Error registering activity lifecycle callbacks.", exception0);
            }
        }
    }
    ...
    private final void zzm(View view0) {
        ...
        zzcaa.zzh("Error while unregistering listeners from the last ViewTreeObserver.", exception0);
        try {
        label_10:
            ...
            zzcaa.zzh("Error while unregistering listeners from the ViewTreeObserver.", exception1);
        }
        if(this.zza != null) {
            try {
                ...
                zzcaa.zzh("Failed trying to unregister the receiver", illegalStateException0);
            }
            catch(Exception exception2) {
                zzt.zzo().zzu(exception2, "ActiveViewUnit.stopScreenStatusMonitoring");
            }
            this.zza = null;
        }
        Application application0 = this.zze;
        if(application0 != null) {
            try {
                ...
                zzcaa.zzh("Error registering activity lifecycle callbacks.", exception3);
            }
        }
    }
}
