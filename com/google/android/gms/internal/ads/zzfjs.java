...
public final class zzfjs implements zzfjq {
    ...
    public final JSONObject zza(View view0) {
        boolean z = false;
        JSONObject jSONObject0 = zzfjz.zza(0, 0, 0, 0);
        int v = zzfkc.zzb();
        if(v == 0) {
            throw null;
        }
        ...
        try {
            ...
            zzfka.zza("Error with setting output device status", jSONException0);
        }
        return jSONObject0;
    }
    ...
    public final void zzb(View view0, JSONObject jSONObject0, zzfjp zzfjp0, boolean z, boolean z1) {
            ...
            while(iterator0.hasNext()) {
                ...
                if(view1 != null && view1.isAttachedToWindow() && view1.isShown()) {
                    ...
                    if(view3 != null && !identityHashMap0.containsKey(view3)) {
                        ...
                        float f = zzfkf.zza(view3);
                        int v;
                        for(v = arrayList0.size(); v > 0 && zzfkf.zza(((View)arrayList0.get(v - 1))) > f; --v) {
                        }
        ...
        v1 = arrayList0.size();
        for(v2 = 0; v2 < v1; ++v2) {
            zzfjp0.zza(((View)arrayList0.get(v2)), this.zza, jSONObject0, z1);
        }
    }
}
