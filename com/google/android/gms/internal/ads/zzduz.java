...
public final class zzduz {
    ...
    public static final void zzb(Context context0, ViewGroup viewGroup0, NativeAd nativeAd0) {
        ...
        linearLayout0.addView(zzduz.zzc(context0, (resources0 == null ? "Headline" : resources0.getString(string.native_headline)), "headline_header_tag"));
        TextView textView0 = zzduz.zzd(context0, zzfrx.zzc(nativeAd0.getHeadline()), "headline_tag");
        nativeAdView0.setHeadlineView(textView0);
        linearLayout0.addView(textView0);
        linearLayout0.addView(zzduz.zzc(context0, (resources0 == null ? "Body" : resources0.getString(string.native_body)), "body_header_tag"));
        TextView textView1 = zzduz.zzd(context0, zzfrx.zzc(nativeAd0.getBody()), "body_tag");
        nativeAdView0.setBodyView(textView1);
        linearLayout0.addView(textView1);
        linearLayout0.addView(zzduz.zzc(context0, (resources0 == null ? "Media View" : resources0.getString(string.native_media_view)), "media_view_header_tag"));
    ...
    private static TextView zzc(Context context0, String s, String s1) {
        return zzduz.zze(context0, s, 0x1030046, -9210245, 0.0f, s1);
    }

    private static TextView zzd(Context context0, String s, String s1) {
        return zzduz.zze(context0, s, 0x1030044, 0xFF000000, 12.0f, s1);
    }
