...
public final class zzcdx extends zzcdu {
    ...
    static {
        zzcdx.zze = Collections.synchronizedSet(new HashSet());
        zzcdx.zzf = new DecimalFormat("#,###");
    }

    public zzcdx(zzccj zzccj0) {
        super(zzccj0);
        ...
        if(!file1.isDirectory() && !this.zzg.mkdirs()) {
            zzcaa.zzj(("Could not create preload cache directory at " + this.zzg.getAbsolutePath()));
            this.zzg = null;
            return;
        }
        ...
        zzcaa.zzj(("Could not set cache file permissions at " + this.zzg.getAbsolutePath()));
        this.zzg = null;
    }

    private final File zza(File file0) {
        return new File(this.zzg, file0.getName() + ".done");
    }
    ...
    public final boolean zzt(String s) {
        ...
        if(this.zzg != null) {
            while(true) {
                ...
                if(v > ((int)(((Integer)zzba.zzc().zzb(zzbbr.zzu))))) {
                    File file1 = this.zzg;
                    if(file1 != null) {
                    ...
                    zzcaa.zzj("Unable to expire stream cache");
            ...
            synchronized(set0) {
                if(set0.contains(s3)) {
                    zzcaa.zzj(("Stream cache already in progress at " + s));
            ...
            try {
                HttpURLConnection httpURLConnection0 = zzfnn.zza().zzn(new zzcdw(s), 0x109, -1);
                ...
                label_69:
                    ...
                    if(v8 < 0) {
                        zzcaa.zzj(("Stream cache aborted, missing content-length header at " + s));
                        this.zzg(s, file5.getAbsolutePath(), "contentLengthMissing", null);
                        set0.remove(s3);
                        return false;
                    }
                    String s4 = zzcdx.zzf.format(((long)v8));
                    v9 = (int)(((Integer)zzba.zzc().zzb(zzbbr.zzv)));
                    if(v8 > v9) {
                        zzcaa.zzj(("Content length " + s4 + " exceeds limit at " + s));
                        this.zzg(s, file5.getAbsolutePath(), "sizeExceeded", "File too big for full file cache. Size: " + s4);
                        set0.remove(s3);
                        return false;
                    }
                    zzcaa.zze(("Caching " + s4 + " bytes from " + s));
            ...
            label_85:
                ...
                zzbz0 = new zzbz(((long)(((Long)zzba.zzc().zzb(zzbbr.zzy)))));
                v11 = (long)(((Long)zzba.zzc().zzb(zzbbr.zzx)));
                v12 = 0;
                while(true) {
                label_92:
            ...
            try {
                ...
                try {
                    ...
                    goto label_174;
                label_121:
                    zzbzt.zza.post(new zzcdo(this, s, s6, v12, v8, false));
                    goto label_130;
                label_123:
                    zzbz1 = zzbz0;
                    fileChannel1 = fileChannel0;
            ...
            try {
                ...
                label_160:
                    ...
                    if(zzcaa.zzm(3)) {
                        zzcaa.zze(("Preloaded " + zzcdx.zzf.format(((long)v12)) + " bytes from " + s));
                    }
        ...
        label_195:
            if(iOException0 instanceof RuntimeException) {
                zzt.zzo().zzu(iOException0, "VideoStreamFullFileCache.preload");
            }
            try {
            ...
            if(this.zzh) {
                zzcaa.zzi(("Preload aborted for URL \"" + s + "\""));
            }
            else {
                zzcaa.zzk(("Preload failed for URL \"" + s + "\""), iOException0);
            }
            if(file5.exists() && !file5.delete()) {
                zzcaa.zzj(("Could not delete partial cache file at " + file5.getAbsolutePath()));
            }
