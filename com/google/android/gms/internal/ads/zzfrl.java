...
final class zzfrl implements zzfrj, Serializable {
    private final List zza;

    zzfrl(List list0, zzfrk zzfrk0) {
        this.zza = list0;
    }
    ...
    public final boolean equals(Object object0) {
        return object0 instanceof zzfrl ? this.zza.equals(((zzfrl)object0).zza) : false;
    }
    ...
    public final boolean zza(Object object0) {
        for(int v = 0; v < this.zza.size(); ++v) {
            if(!((zzfrj)this.zza.get(v)).zza(object0)) {
                return false;
            }
        }
        return true;
