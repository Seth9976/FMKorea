...
public final class zzasf implements Application.ActivityLifecycleCallbacks, View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener {
    ...
    static {
        zzasf.zza = new Handler(Looper.getMainLooper());
    }

    public zzasf(Context context0, zzarr zzarr0) {
        this.zzk = -1;
        this.zzl = -1;
        this.zzm = -3L;
        ...
        if(context1 instanceof Application) {
            ...
            this.zzj = new zzarn(((Application)context1), this);
        }
        this.zzd(null);
    }
    ...
    private final void zzg() {
        zzasd zzasd0 = new zzasd(this);
        zzasf.zza.post(zzasd0);
    }
    ...
    private final void zzh(View view0) {
        ...
        if(this.zzf == null) {
            ...
            zzase zzase0 = new zzase(this);
            this.zzf = zzase0;
            this.zzb.registerReceiver(zzase0, intentFilter0);
        }
