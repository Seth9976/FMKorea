...
public final class zzdpj {
        ...
        if(jSONArray0 != null) {
            for(int v = 0; v < jSONArray0.length(); ++v) {
                ...
                if(jSONObject1 != null) {
                    ...
                    if(zzdpj.zzb(jSONArray1, s) && !zzdpj.zzb(jSONArray2, s)) {
    ...
    private static boolean zzb(JSONArray jSONArray0, String s) {
        if(jSONArray0 != null && s != null) {
            for(int v = 0; v < jSONArray0.length(); ++v) {
                String s1 = jSONArray0.optString(v);
                try {
                    if((((Boolean)zzba.zzc().zzb(zzbbr.zzjP)).booleanValue() ? Pattern.compile(s1, 2) : Pattern.compile(s1)).matcher(s).lookingAt()) {
                        return true;
                    }
                }
                catch(PatternSyntaxException patternSyntaxException0) {
                    zzt.zzo().zzu(patternSyntaxException0, "RtbAdapterMap.hasAtleastOneRegexMatch");
                }
            }
        }
        return false;
