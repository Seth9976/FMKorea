...
public class zzaaq implements zzaca {
    ...
    public zzaaq(long v, long v1, int v2, int v3, boolean z) {
        long v4;
        this.zza = v;
        this.zzb = v1;
        if(v3 == -1) {
        ...
        if(v == -1L) {
            ...
            this.zzd = v - v1;
            v4 = zzaaq.zzb(v, v1, v2);
        }
        this.zzf = v4;
    }

    public final long zza(long v) {
        return zzaaq.zzb(v, this.zzb, this.zze);
    }

    private static long zzb(long v, long v1, int v2) {
    ...
    public final zzaby zzg(long v) {
        ...
        if(Long.compare(v1, -1L) != 0) {
            ...
            long v4 = this.zza(v3);
            zzacb zzacb0 = new zzacb(v4, v3);
            if(this.zzd != -1L && v4 < v) {
                long v5 = v3 + ((long)this.zzc);
                return v5 >= this.zza ? new zzaby(zzacb0, zzacb0) : new zzaby(zzacb0, new zzacb(this.zza(v5), v5));
            }
            return new zzaby(zzacb0, zzacb0);
        }
        zzacb zzacb1 = new zzacb(0L, this.zzb);
