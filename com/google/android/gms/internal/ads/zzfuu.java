...
abstract class zzfuu extends zzfvy {
    ...
    public boolean contains(Object object0) {
        if(object0 instanceof Map.Entry) {
            ...
            Object object2 = zzfuy.zza(this.zza(), object1);
            return zzfrd.zza(object2, ((Map.Entry)object0).getValue()) && (object2 != null || this.zza().containsKey(object1));
        }
        return false;
    }
    ...
    public final boolean removeAll(Collection collection0) {
        try {
            ...
            return zzfvz.zzd(this, collection0);
        }
        catch(UnsupportedOperationException unused_ex) {
            return zzfvz.zze(this, collection0.iterator());
        }
    }
