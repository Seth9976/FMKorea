...
final class zzgrr extends zzgps implements zzgrv, zzgth, RandomAccess {
    private static final zzgrr zza;
    private int[] zzb;
    private int zzc;

    static {
        zzgrr.zza = new zzgrr(new int[0], 0, false);
    }
    ...
    private zzgrr(int[] arr_v, int v, boolean z) {
        super(z);
        this.zzb = arr_v;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzgrr)) {
            return super.addAll(collection0);
        }
        int v = ((zzgrr)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzgrr)collection0).zzb, 0, this.zzb, this.zzc, ((zzgrr)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzgrr)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzgrr)object0).zzc) {
            return false;
        }
        int[] arr_v = ((zzgrr)object0).zzb;
    ...
    public final zzgrv zzg(int v) {
        if(v < this.zzc) {
            throw new IllegalArgumentException();
        }
        return new zzgrr(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
