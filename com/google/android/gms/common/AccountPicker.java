...
public final class AccountPicker {
    public static class AccountChooserOptions {
        ...
        static Account zzb(AccountChooserOptions accountPicker$AccountChooserOptions0) {
            return accountPicker$AccountChooserOptions0.zza;
        }

        static Bundle zzc(AccountChooserOptions accountPicker$AccountChooserOptions0) {
            return accountPicker$AccountChooserOptions0.zzg;
        }
    ...
    public static Intent newChooseAccountIntent(AccountChooserOptions accountPicker$AccountChooserOptions0) {
        ...
        intent0.putExtra("addAccountOptions", AccountChooserOptions.zzc(accountPicker$AccountChooserOptions0));
        intent0.putExtra("selectedAccount", AccountChooserOptions.zzb(accountPicker$AccountChooserOptions0));
