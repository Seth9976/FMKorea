...
public abstract class FastJsonResponse {
    ...
    public static class Field extends AbstractSafeParcelable {
        ...
        @Constructor
        Field(@Param(id = 1) int v, @Param(id = 2) int v1, @Param(id = 3) boolean z, @Param(id = 4) int v2, @Param(id = 5) boolean z1, @Param(id = 6) String s, @Param(id = 7) int v3, @Param(id = 8) String s1, @Param(id = 9) zaa zaa0) {
            this.zai = v;
            this.zaa = v1;
            this.zab = z;
            this.zac = v2;
        ...
        protected Field(int v, boolean z, int v1, boolean z1, String s, int v2, java.lang.Class class0, FieldConverter fastJsonResponse$FieldConverter0) {
            this.zai = 1;
            this.zaa = v;
            this.zab = z;
            this.zac = v1;
