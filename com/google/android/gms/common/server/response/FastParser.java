...
public class FastParser {
    ...
    static {
        ...
        FastParser.zag = new zaa();
        FastParser.zah = new zab();
        FastParser.zai = new zac();
        FastParser.zaj = new zad();
        FastParser.zak = new zae();
        FastParser.zal = new zaf();
        FastParser.zam = new zag();
        FastParser.zan = new zah();
    }
    ...
    private final String zao(BufferedReader bufferedReader0) {
        return this.zap(bufferedReader0, this.zap, this.zar, null);
    }
