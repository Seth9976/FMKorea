    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for(Object object0: this.zaj.keySet()) {
                ...
                a0.put(((Api)object0), Boolean.valueOf(z));
                ...
                a1.put(((Api)object0).zab(), api$Client0);
            ...
            int v = zabe.zad(a1.values(), true);
            ReentrantLock reentrantLock0 = new ReentrantLock();
            GoogleApiClient googleApiClient0 = new zabe(this.zai, reentrantLock0, this.zan, clientSettings0, this.zao, this.zap, a0, this.zaq, this.zar, a1, this.zal, v, arrayList0);
        ...
        public Builder enableAutoManage(h h0, int v, OnConnectionFailedListener googleApiClient$OnConnectionFailedListener0) {
            LifecycleActivity lifecycleActivity0 = new LifecycleActivity(h0);
        ...
        public Builder enableAutoManage(h h0, OnConnectionFailedListener googleApiClient$OnConnectionFailedListener0) {
            this.enableAutoManage(h0, 0, googleApiClient$OnConnectionFailedListener0);
            return this;
        }
