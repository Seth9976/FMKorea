...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public zzd() {
        this.zzb = Collections.synchronizedMap(new a());
        this.zzc = 0;
    }
    ...
    public static zzd zzc(h h0) {
        zzd zzd1;
        WeakHashMap weakHashMap0 = zzd.zza;
        WeakReference weakReference0 = (WeakReference)weakHashMap0.get(h0);
        ...
        try {
            zzd1 = (zzd)h0.P0().i0("SupportLifecycleFragmentImpl");
        }
        ...
        if(zzd1 == null || zzd1.isRemoving()) {
            zzd1 = new zzd();
            h0.P0().p().d(zzd1, "SupportLifecycleFragmentImpl").h();
        }
        weakHashMap0.put(h0, new WeakReference(zzd1));
        return zzd1;
    }
}
