...
public class ConnectionTracker {
    ...
    @ResultIgnorabilityUnspecified
    public final boolean zza(Context context0, String s, Intent intent0, ServiceConnection serviceConnection0, int v, Executor executor0) {
    ...
    private final boolean zzc(Context context0, String s, Intent intent0, ServiceConnection serviceConnection0, int v, boolean z, Executor executor0) {
    ...
    private static final boolean zze(Context context0, Intent intent0, ServiceConnection serviceConnection0, int v, Executor executor0) {
        if(executor0 == null) {
            executor0 = null;
        }
