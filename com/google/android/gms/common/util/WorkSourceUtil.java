...
public class WorkSourceUtil {
    ...
    static {
        ...
        try {
            method0 = null;
            method0 = class0.getMethod("add", Integer.TYPE);
        }
        ...
        try {
            ...
            class1 = String.class;
            method1 = null;
            method1 = class0.getMethod("add", Integer.TYPE, class1);
        }
        catch(Exception unused_ex) {
        }
        try {
            ...
            method2 = null;
            method2 = class0.getMethod("size", null);
        }
        catch(Exception unused_ex) {
        }
        try {
            ...
            method3 = null;
            method3 = class0.getMethod("get", Integer.TYPE);
        }
        catch(Exception unused_ex) {
        }
        try {
            ...
            method4 = null;
            method4 = class0.getMethod("getName", Integer.TYPE);
        }
        catch(Exception unused_ex) {
        }
        try {
            WorkSourceUtil.zzf = method4;
            method5 = class0.getMethod("createWorkChain", null);
        }
        ...
        try {
            ...
            method6 = Class.forName("android.os.WorkSource$WorkChain").getMethod("addNode", Integer.TYPE, class1);
        }
        ...
        try {
            ...
            method7 = null;
            method7 = class0.getMethod("isEmpty", null);
    ...
    public static boolean hasWorkSourcePermission(Context context0) {
        synchronized(WorkSourceUtil.class) {
            ...
            if(a.checkSelfPermission(context0, "android.permission.UPDATE_DEVICE_STATS") == 0) {
                z = true;
            }
