...
public class PackageManagerWrapper {
    ...
    @KeepForSdk
    @ResultIgnorabilityUnspecified
    public d getApplicationLabelAndIcon(String s) {
        ApplicationInfo applicationInfo0 = this.zza.getPackageManager().getApplicationInfo(s, 0);
        return d.a(this.zza.getPackageManager().getApplicationLabel(applicationInfo0), this.zza.getPackageManager().getApplicationIcon(applicationInfo0));
    }
