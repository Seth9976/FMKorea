...
public final class Asserts {
    ...
    public static void checkMainThread(String s) {
        ...
        Log.e("Asserts", "checkMainThread: current thread Thread[jeb-dexdec-sb-st-17374,5,main] IS NOT the main thread " + Looper.getMainLooper().getThread() + "!");
    ...
    public static void checkNotMainThread(String s) {
        ...
        Log.e("Asserts", "checkNotMainThread: current thread Thread[jeb-dexdec-sb-st-17371,5,main] IS the main thread " + Looper.getMainLooper().getThread() + "!");
        throw new IllegalStateException(s);
    }
    ...
    @KeepForSdk
    public static void checkNull(Object object0, Object object1) {
        if(object0 != null) {
            throw new IllegalArgumentException(String.valueOf(object1));
        }
    }
