...
public final class zac {
    ...
    public static String zaa(Context context0) {
        try {
            return Wrappers.packageManager(context0).getApplicationLabel("com.fmkorea.m.fmk").toString();
        }
        catch(PackageManager.NameNotFoundException | NullPointerException unused_ex) {
            String s = context0.getApplicationInfo().name;
            return TextUtils.isEmpty(s) ? "com.fmkorea.m.fmk" : s;
        }
    }
    ...
    private static String zah(Context context0, String s) {
        g g0 = zac.zaa;
        synchronized(g0) {
            Locale locale0 = e.a(context0.getResources().getConfiguration()).d(0);
