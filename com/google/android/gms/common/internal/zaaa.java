...
public final class zaaa extends Button {
    ...
    public final void zaa(Resources resources0, int v, int v1) {
        ...
        Drawable drawable0 = a.r(resources0.getDrawable(v3));
        a.o(drawable0, resources0.getColorStateList(color.common_google_signin_btn_tint));
        a.p(drawable0, PorterDuff.Mode.SRC_ATOP);
