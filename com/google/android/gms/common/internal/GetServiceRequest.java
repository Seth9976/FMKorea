...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(id = 1) int v, @Param(id = 2) int v1, @Param(id = 3) int v2, @Param(id = 4) String s, @Param(id = 5) IBinder iBinder0, @Param(id = 6) Scope[] arr_scope, @Param(id = 7) Bundle bundle0, @Param(id = 8) Account account0, @Param(id = 10) Feature[] arr_feature, @Param(id = 11) Feature[] arr_feature1, @Param(id = 12) boolean z, @Param(id = 13) int v3, @Param(id = 14) boolean z1, @Param(id = 15) String s1) {
        if(arr_scope == null) {
