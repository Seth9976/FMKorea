...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    final void zad(Activity activity0, Dialog dialog0, String s, DialogInterface.OnCancelListener dialogInterface$OnCancelListener0) {
        if(activity0 instanceof h) {
            FragmentManager fragmentManager0 = ((h)activity0).P0();
    ...
    final void zae(Context context0, int v, String s, PendingIntent pendingIntent0) {
        ...
        e m$e0 = new e(context0).u(true).f(true).l(s1).B(new c().h(s2));
        if(DeviceProperties.isWearable(context0)) {
            Preconditions.checkState(true);
            m$e0.z(context0.getApplicationInfo().icon).x(2);
            if(DeviceProperties.isWearableWithoutPlayStore(context0)) {
                String s3 = resources0.getString(string.common_open_on_phone);
                m$e0.a(drawable.common_full_open_on_phone, s3, pendingIntent0);
            }
            else {
                m$e0.j(pendingIntent0);
            }
        }
        else {
            m$e0.z(0x108008A).C(resources0.getString(string.common_google_play_services_notification_ticker)).F(System.currentTimeMillis()).j(pendingIntent0).k(s2);
        }
        Preconditions.checkState(true);
        synchronized(GoogleApiAvailability.zaa) {
            s4 = this.zac;
        ...
        if(s4 == null) {
            ...
            if(notificationChannel0 == null) {
                notificationManager0.createNotificationChannel(com.google.android.gms.ads.internal.util.h.a("com.google.android.gms.availability", s5, 4));
            }
            else if(!s5.contentEquals(a.a(notificationChannel0))) {
                com.google.android.gms.common.b.a(notificationChannel0, s5);
