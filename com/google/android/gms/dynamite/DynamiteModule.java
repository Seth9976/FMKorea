...
public final class DynamiteModule {
    ...
    public interface VersionPolicy {
        ...
        public interface IVersions {
            ...
            int zzb(Context arg1, String arg2, boolean arg3);
        }
                ...
                try {
                    ...
                    label_67:
                        ...
                        if(DynamiteModule.zze >= 2) {
                            ...
                            iObjectWrapper0 = zzr0.zzf(ObjectWrapper.wrap(context2), s, v2, ObjectWrapper.wrap(cursor0));
                        }
                        else {
                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                            iObjectWrapper0 = zzr0.zze(ObjectWrapper.wrap(context2), s, v2, ObjectWrapper.wrap(cursor0));
                        }
                    ...
                    label_84:
                        ...
                        int v3 = zzq0.zze();
                        if(v3 >= 3) {
                            zzn zzn4 = (zzn)threadLocal0.get();
                            if(zzn4 == null) {
                                throw new LoadingException("No cached result cursor holder", null);
                            }
                            iObjectWrapper1 = zzq0.zzi(ObjectWrapper.wrap(context0), s, v2, ObjectWrapper.wrap(zzn4.zza));
                        }
                        else if(v3 == 2) {
                            Log.w("DynamiteModule", "IDynamite loader version = 2");
                            iObjectWrapper1 = zzq0.zzj(ObjectWrapper.wrap(context0), s, v2);
                        }
                        else {
                            Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                            iObjectWrapper1 = zzq0.zzh(ObjectWrapper.wrap(context0), s, v2);
                        }
    ...
    private static int zzb(Context context0, String s, boolean z, boolean z1) {
        int v1;
    ...
    private static void zzd(ClassLoader classLoader0) {
        zzr zzr0;
        try {
