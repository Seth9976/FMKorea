...
public final class zzq extends zza implements IInterface {
    ...
    public final int zzg(IObjectWrapper iObjectWrapper0, String s, boolean z) {
        Parcel parcel0 = this.zza();
        zzc.zze(parcel0, iObjectWrapper0);
        parcel0.writeString(s);
        parcel0.writeInt(((int)z));
    ...
    public final IObjectWrapper zzh(IObjectWrapper iObjectWrapper0, String s, int v) {
        Parcel parcel0 = this.zza();
        zzc.zze(parcel0, iObjectWrapper0);
        parcel0.writeString(s);
        parcel0.writeInt(v);
    ...
    public final IObjectWrapper zzi(IObjectWrapper iObjectWrapper0, String s, int v, IObjectWrapper iObjectWrapper1) {
        Parcel parcel0 = this.zza();
        zzc.zze(parcel0, iObjectWrapper0);
        parcel0.writeString(s);
        parcel0.writeInt(v);
    ...
    public final IObjectWrapper zzj(IObjectWrapper iObjectWrapper0, String s, int v) {
        Parcel parcel0 = this.zza();
        zzc.zze(parcel0, iObjectWrapper0);
        parcel0.writeString(s);
        parcel0.writeInt(v);
    ...
    public final IObjectWrapper zzk(IObjectWrapper iObjectWrapper0, String s, boolean z, long v) {
        Parcel parcel0 = this.zza();
        zzc.zze(parcel0, iObjectWrapper0);
        parcel0.writeString(s);
        parcel0.writeInt(((int)z));
