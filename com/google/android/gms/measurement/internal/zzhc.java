...
final class zzhc extends Thread {
    ...
    public zzhc(zzgy zzgy0, String s, BlockingQueue blockingQueue0) {
        this.zzd = zzgy0;
        super();
        this.zzc = false;
    ...
    public final void run() {
        ...
        while(true) {
            ...
            label_43:
                ...
                Process.setThreadPriority((zzhd0.zza ? v1 : 10));
                zzhd0.run();
            }
        }
    }
        ...
        synchronized(this.zzd.zzh) {
            if(!this.zzc) {
                ...
                if(this == this.zzd.zzb) {
                    zzgy.zzb(this.zzd, null);
                }
                else if(this == this.zzd.zzc) {
                    zzgy.zza(this.zzd, null);
                }
                else {
