...
public final class zzfo extends zze {
    ...
    zzfo(zzhf zzhf0) {
        super(zzhf0);
        this.zza = new zzfn(this, this.zza(), "google_app_measurement_local.db");
    }
        ...
        label_42:
            ...
            try {
                try {
                    ...
                    zzbg0 = (zzbg)zzbg.CREATOR.createFromParcel(parcel0);
                    goto label_74;
                }
            ...
            try {
                try {
                    ...
                    zznc0 = (zznc)zznc.CREATOR.createFromParcel(parcel1);
                    goto label_90;
                }
                catch(ParseException unused_ex) {
                }
            ...
            try {
                try {
                    ...
                    zzad0 = (zzad)zzad.CREATOR.createFromParcel(parcel2);
                    goto label_106;
                }
                catch(ParseException unused_ex) {
                }
    ...
    public final boolean zza(zzad zzad0) {
        this.zzq();
        byte[] arr_b = zznd.zza(zzad0);
        if(arr_b.length > 0x20000) {
            this.zzj().zzm().zza("Conditional user property too long for local database. Sending directly to service");
            return false;
        }
        return this.zza(2, arr_b);
    }

    public final boolean zza(zzbg zzbg0) {
        Parcel parcel0 = Parcel.obtain();
        zzbg0.writeToParcel(parcel0, 0);
        byte[] arr_b = parcel0.marshall();
        parcel0.recycle();
        if(arr_b.length > 0x20000) {
            this.zzj().zzm().zza("Event is too long for local database. Sending event directly to service");
            return false;
        }
        return this.zza(0, arr_b);
    }

    public final boolean zza(zznc zznc0) {
        Parcel parcel0 = Parcel.obtain();
        zznc0.writeToParcel(parcel0, 0);
        byte[] arr_b = parcel0.marshall();
        parcel0.recycle();
        if(arr_b.length > 0x20000) {
            this.zzj().zzm().zza("User property too long for local database. Sending directly to service");
            return false;
        }
