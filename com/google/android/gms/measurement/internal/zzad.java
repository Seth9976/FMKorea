...
public final class zzad extends AbstractSafeParcelable {
    ...
    @Constructor
    zzad(@Param(id = 2) String s, @Param(id = 3) String s1, @Param(id = 4) zznc zznc0, @Param(id = 5) long v, @Param(id = 6) boolean z, @Param(id = 7) String s2, @Param(id = 8) zzbg zzbg0, @Param(id = 9) long v1, @Param(id = 10) zzbg zzbg1, @Param(id = 11) long v2, @Param(id = 12) zzbg zzbg2) {
        this.zza = s;
        this.zzb = s1;
        this.zzc = zznc0;
        this.zzd = v;
