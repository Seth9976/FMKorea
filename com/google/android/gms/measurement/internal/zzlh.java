...
final class zzlh implements Runnable {
    ...
    zzlh(zzkp zzkp0, AtomicReference atomicReference0, String s, String s1, String s2, zzo zzo0) {
        this.zzf = zzkp0;
            ...
            try {
                ...
                if(zzfk0 != null) {
                    if(TextUtils.isEmpty(this.zzb)) {
                        ...
                        List list0 = zzfk0.zza(this.zzc, this.zzd, this.zze);
                        this.zza.set(list0);
                    }
                    else {
                        List list1 = zzfk0.zza(this.zzb, this.zzc, this.zzd);
                        this.zza.set(list1);
                    }
                    this.zzf.zzal();
                    goto label_21;
                ...
                this.zzf.zzj().zzg().zza("(legacy) Failed to get conditional properties; remote exception", zzfr.zza(this.zzb), this.zzc, remoteException0);
