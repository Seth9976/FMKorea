...
public final class zzgf {
    ...
    public zzgf(zzgd zzgd0, String s, Bundle bundle0) {
        this.zzd = zzgd0;
        super();
    ...
    public final Bundle zza() {
        if(this.zzc == null) {
            String s = this.zzd.zzc().getString(this.zza, null);
            if(s != null) {
                try {
    ...
    public final void zza(Bundle bundle0) {
        ...
        SharedPreferences.Editor sharedPreferences$Editor0 = this.zzd.zzc().edit();
        if(bundle0.size() == 0) {
