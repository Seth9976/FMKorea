...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Constructor
    GoogleSignInOptions(@Param(id = 1) int v, @Param(id = 2) ArrayList arrayList0, @Param(id = 3) Account account0, @Param(id = 4) boolean z, @Param(id = 5) boolean z1, @Param(id = 6) boolean z2, @Param(id = 7) String s, @Param(id = 8) String s1, @Param(id = 9) ArrayList arrayList1, @Param(id = 10) String s2) {
