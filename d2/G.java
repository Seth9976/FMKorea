...
public final class g {
    ...
    public List b() {
        ...
        for(Object object0: this.b.a(this.a)) {
            list0.add(() -> g.e(((String)object0)));
        }
        return list0;
    }

    public static g c(Context context0, Class class0) {
        return new g(context0, new b(class0, null));
    }

    private static ComponentRegistrar d(String s) {
        try {
            Class class0 = Class.forName(s);
            if(!ComponentRegistrar.class.isAssignableFrom(class0)) {
                throw new w(String.format("Class %s is not an instance of %s", s, "com.google.firebase.components.ComponentRegistrar"));
            }
            ...
            throw new w(String.format("Could not instantiate %s.", s), illegalAccessException0);
        }
        catch(InstantiationException instantiationException0) {
            throw new w(String.format("Could not instantiate %s.", s), instantiationException0);
        }
        catch(NoSuchMethodException noSuchMethodException0) {
            throw new w(String.format("Could not instantiate %s", s), noSuchMethodException0);
        }
        catch(InvocationTargetException invocationTargetException0) {
            throw new w(String.format("Could not instantiate %s", s), invocationTargetException0);
        }
