...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplApi21 implements ConnectionCallbackInternal, MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        private final a mSubscriptions;
        ...
        public void onConnected() {
            ...
            IBinder iBinder0 = g.a(bundle0, "extra_messenger");
            if(iBinder0 != null) {
            ...
            IMediaSession iMediaSession0 = Stub.asInterface(g.a(bundle0, "extra_session_binder"));
    ...
    static class ServiceBinderWrapper {
        ...
        void addSubscription(String s, IBinder iBinder0, Bundle bundle0, Messenger messenger0) {
            Bundle bundle1 = new Bundle();
            bundle1.putString("data_media_item_id", s);
            g.b(bundle1, "data_callback_token", iBinder0);
            bundle1.putBundle("data_options", bundle0);
            this.sendRequest(3, bundle1, messenger0);
        }

        void connect(Context context0, Messenger messenger0) {
            Bundle bundle0 = new Bundle();
            bundle0.putString("data_package_name", "com.fmkorea.m.fmk");
            bundle0.putBundle("data_root_hints", this.mRootHints);
            this.sendRequest(1, bundle0, messenger0);
        }

        void disconnect(Messenger messenger0) {
            this.sendRequest(2, null, messenger0);
        }

        void getMediaItem(String s, ResultReceiver resultReceiver0, Messenger messenger0) {
            Bundle bundle0 = new Bundle();
        ...
        void registerCallbackMessenger(Context context0, Messenger messenger0) {
            Bundle bundle0 = new Bundle();
            bundle0.putString("data_package_name", "com.fmkorea.m.fmk");
            bundle0.putBundle("data_root_hints", this.mRootHints);
        ...
        void removeSubscription(String s, IBinder iBinder0, Messenger messenger0) {
            Bundle bundle0 = new Bundle();
            bundle0.putString("data_media_item_id", s);
            g.b(bundle0, "data_callback_token", iBinder0);
            this.sendRequest(4, bundle0, messenger0);
        }

        void search(String s, Bundle bundle0, ResultReceiver resultReceiver0, Messenger messenger0) {
            Bundle bundle1 = new Bundle();
        ...
        void sendCustomAction(String s, Bundle bundle0, ResultReceiver resultReceiver0, Messenger messenger0) {
            Bundle bundle1 = new Bundle();
        ...
        void unregisterCallbackMessenger(Messenger messenger0) {
    ...
    static class Subscription {
        ...
        public SubscriptionCallback getCallback(Bundle bundle0) {
            for(int v = 0; v < this.mOptionsList.size(); ++v) {
                if(androidx.media.a.a(((Bundle)this.mOptionsList.get(v)), bundle0)) {
