...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final a METADATA_KEYS_TYPE = null;
    ...
    static {
        a a0 = new a();
        MediaMetadataCompat.METADATA_KEYS_TYPE = a0;
        a0.put("android.media.metadata.TITLE", 1);
        a0.put("android.media.metadata.ARTIST", 1);
        a0.put("android.media.metadata.DURATION", 0);
        a0.put("android.media.metadata.ALBUM", 1);
        a0.put("android.media.metadata.AUTHOR", 1);
        a0.put("android.media.metadata.WRITER", 1);
        a0.put("android.media.metadata.COMPOSER", 1);
        a0.put("android.media.metadata.COMPILATION", 1);
        a0.put("android.media.metadata.DATE", 1);
        a0.put("android.media.metadata.YEAR", 0);
        a0.put("android.media.metadata.GENRE", 1);
        a0.put("android.media.metadata.TRACK_NUMBER", 0);
        a0.put("android.media.metadata.NUM_TRACKS", 0);
        a0.put("android.media.metadata.DISC_NUMBER", 0);
        a0.put("android.media.metadata.ALBUM_ARTIST", 1);
        a0.put("android.media.metadata.ART", 2);
        a0.put("android.media.metadata.ART_URI", 1);
        a0.put("android.media.metadata.ALBUM_ART", 2);
        a0.put("android.media.metadata.ALBUM_ART_URI", 1);
        a0.put("android.media.metadata.USER_RATING", 3);
        a0.put("android.media.metadata.RATING", 3);
        a0.put("android.media.metadata.DISPLAY_TITLE", 1);
        a0.put("android.media.metadata.DISPLAY_SUBTITLE", 1);
        a0.put("android.media.metadata.DISPLAY_DESCRIPTION", 1);
        a0.put("android.media.metadata.DISPLAY_ICON", 2);
        a0.put("android.media.metadata.DISPLAY_ICON_URI", 1);
        a0.put("android.media.metadata.MEDIA_ID", 1);
        a0.put("android.media.metadata.BT_FOLDER_TYPE", 0);
        a0.put("android.media.metadata.MEDIA_URI", 1);
        a0.put("android.media.metadata.ADVERTISEMENT", 0);
        a0.put("android.media.metadata.DOWNLOAD_STATUS", 0);
