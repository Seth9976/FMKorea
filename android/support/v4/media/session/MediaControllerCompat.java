...
public final class MediaControllerCompat {
    ...
    static class MediaControllerExtraData extends a {
            ...
            protected void onReceiveResult(int v, Bundle bundle0) {
                ...
                if(mediaControllerCompat$MediaControllerImplApi210 != null && bundle0 != null) {
                    synchronized(mediaControllerCompat$MediaControllerImplApi210.mLock) {
                        IMediaSession iMediaSession0 = android.support.v4.media.session.IMediaSession.Stub.asInterface(g.a(bundle0, "android.support.v4.media.session.EXTRA_BINDER"));
    ...
    static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
        public MediaControllerImplApi23(Context context0, Token mediaSessionCompat$Token0) {
    ...
    static class MediaControllerImplApi24 extends MediaControllerImplApi23 {
        public MediaControllerImplApi24(Context context0, Token mediaSessionCompat$Token0) {
            super(context0, mediaSessionCompat$Token0);
        }
    ...
    public static MediaControllerCompat getMediaController(Activity activity0) {
        if(activity0 instanceof h) {
            MediaControllerExtraData mediaControllerCompat$MediaControllerExtraData0 = (MediaControllerExtraData)((h)activity0).p0(MediaControllerExtraData.class);
    ...
    public static void setMediaController(Activity activity0, MediaControllerCompat mediaControllerCompat0) {
        if(activity0 instanceof h) {
            ((h)activity0).q0(new MediaControllerExtraData(mediaControllerCompat0));
        }
