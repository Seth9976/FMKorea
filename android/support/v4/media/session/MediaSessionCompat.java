...
public class MediaSessionCompat {
    public static abstract class Callback {
        class CallbackHandler extends Handler {
            ...
            public void handleMessage(Message message0) {
                if(message0.what == 1) {
                    Callback.this.handleMediaPlayPauseKeySingleTapIfPending(((b)message0.obj));
                }
            }
        }
                ...
                try {
                    ...
                    if(s.equals("android.support.v4.media.session.command.GET_EXTRA_BINDER")) {
                        ...
                        if(mediaSessionCompat$MediaSessionImplApi211 != null) {
                            ...
                            g.b(bundle1, "android.support.v4.media.session.EXTRA_BINDER", iBinder0);
        ...
        void handleMediaPlayPauseKeySingleTapIfPending(b b0) {
            ...
            mediaSessionCompat$MediaSessionImpl0.setCurrentControllerInfo(b0);
        ...
        public boolean onMediaButtonEvent(Intent intent0) {
            ...
            if(mediaSessionCompat$MediaSessionImpl0 != null && this.mCallbackHandler != null) {
                ...
                if(keyEvent0 != null && keyEvent0.getAction() == 0) {
                    b b0 = mediaSessionCompat$MediaSessionImpl0.getCurrentControllerInfo();
                    switch(keyEvent0.getKeyCode()) {
                        case 0x4F: 
                        case 85: {
                            if(keyEvent0.getRepeatCount() > 0) {
                                this.handleMediaPlayPauseKeySingleTapIfPending(b0);
                                return true;
                            }
                            if(this.mMediaPlayPauseKeyPending) {
                                this.mCallbackHandler.removeMessages(1);
                            ...
                            this.mCallbackHandler.sendMessageDelayed(this.mCallbackHandler.obtainMessage(1, b0), 300L);
                            return true;
                        }
                        default: {
                            this.handleMediaPlayPauseKeySingleTapIfPending(b0);
    ...
    interface MediaSessionImpl {
        ...
        void setCurrentControllerInfo(b arg1);
        ...
        void setPlaybackToRemote(h arg1);
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        class ExtraSession extends Stub {
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback0) {
                ...
                if(!mediaSessionCompat$MediaSessionImplApi210.mDestroyed) {
                    ...
                    b b0 = new b(s, Binder.getCallingPid(), Binder.getCallingUid());
                    MediaSessionImplApi21.this.mExtraControllerCallbacks.register(iMediaControllerCallback0, b0);
                }
            }
        ...
        @Override  // android.support.v4.media.session.MediaSessionCompat$MediaSessionImpl
        public void setCurrentControllerInfo(b b0) {
        }
        ...
        @Override  // android.support.v4.media.session.MediaSessionCompat$MediaSessionImpl
        public void setPlaybackToRemote(h h0) {
            throw null;
        }
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MediaSessionStub extends Stub {
            ...
            public ParcelableVolumeInfo getVolumeAttributes() {
                synchronized(MediaSessionImplBase.this.mLock) {
                    int v1 = MediaSessionImplBase.this.mVolumeType;
                    int v2 = MediaSessionImplBase.this.mLocalStream;
                    MediaSessionImplBase.this.getClass();
                    if(v1 != 2) {
                        int v3 = MediaSessionImplBase.this.mAudioManager.getStreamMaxVolume(v2);
                        int v4 = MediaSessionImplBase.this.mAudioManager.getStreamVolume(v2);
                        return new ParcelableVolumeInfo(v1, v2, 2, v3, v4);
                    }
                }
                throw null;
            }
            ...
            public void registerCallbackListener(IMediaControllerCallback iMediaControllerCallback0) {
                ...
                b b0 = new b("android.media.session.MediaController", Binder.getCallingPid(), Binder.getCallingUid());
                MediaSessionImplBase.this.mControllerCallbacks.register(iMediaControllerCallback0, b0);
            }
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message message0) {
                ...
                b b0 = new b(bundle0.getString("data_calling_pkg"), bundle0.getInt("data_calling_pid"), bundle0.getInt("data_calling_uid"));
                MediaSessionImplBase.this.setCurrentControllerInfo(b0);
        ...
        public MediaSessionImplBase(Context context0, String s, ComponentName componentName0, PendingIntent pendingIntent0) {
            ...
            this.mVolumeCallback = new a() {
                public void onVolumeChanged(h h0) {
                    MediaSessionImplBase.this.getClass();
                    throw null;
                }
            };
            ...
            this.mPackageName = "com.fmkorea.m.fmk";
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle0) {
            ...
            IMediaSession iMediaSession0 = Stub.asInterface(g.a(bundle0, "android.support.v4.media.session.EXTRA_BINDER"));
        ...
        public Bundle toBundle() {
            ...
            if(iMediaSession0 != null) {
                g.b(bundle0, "android.support.v4.media.session.EXTRA_BINDER", iMediaSession0.asBinder());
            }
