...
class x {
    static abstract class b {
        ...
        static {
            int[] arr_v = new int[androidx.lifecycle.h.b.values().length];
            b.a = arr_v;
            try {
                arr_v[androidx.lifecycle.h.b.j.ordinal()] = 1;
            }
            catch(NoSuchFieldError unused_ex) {
            }
            try {
                b.a[androidx.lifecycle.h.b.i.ordinal()] = 2;
            }
            catch(NoSuchFieldError unused_ex) {
            }
            try {
                b.a[androidx.lifecycle.h.b.h.ordinal()] = 3;
            }
            catch(NoSuchFieldError unused_ex) {
            }
            try {
                b.a[androidx.lifecycle.h.b.g.ordinal()] = 4;
            }
            catch(NoSuchFieldError unused_ex) {
            }
        }
    ...
    x(o o0, y y0, Fragment fragment0) {
        this.d = false;
        this.e = -1;
        this.a = o0;
        this.b = y0;
    ...
    x(o o0, y y0, Fragment fragment0, FragmentState fragmentState0) {
        this.d = false;
        this.e = -1;
        this.a = o0;
        this.b = y0;
        ...
        Bundle bundle0 = fragmentState0.r;
        if(bundle0 != null) {
    ...
    x(o o0, y y0, ClassLoader classLoader0, l l0, FragmentState fragmentState0) {
        this.d = false;
        this.e = -1;
        this.a = o0;
        this.b = y0;
        Fragment fragment0 = fragmentState0.a(l0, classLoader0);
        this.c = fragment0;
    ...
    void c() {
        ...
        this.c.mHost = this.c.mFragmentManager.u0();
        this.c.mParentFragment = this.c.mFragmentManager.x0();
    ...
    int d() {
        ...
        androidx.fragment.app.F.e.b f$e$b0 = viewGroup0 == null ? null : F.n(viewGroup0, this.c.getParentFragmentManager()).l(this);
        if(f$e$b0 == androidx.fragment.app.F.e.b.g) {
            v = Math.min(v, 6);
        }
        else if(f$e$b0 == androidx.fragment.app.F.e.b.h) {
            v = Math.max(v, 3);
        }
        else {
    ...
    void f() {
        ...
        if(viewGroup0 == null) {
            switch(fragment0.mContainerId) {
                ...
                label_11:
                    viewGroup0 = (ViewGroup)fragment0.mFragmentManager.q0().c(this.c.mContainerId);
                    if(viewGroup0 == null) {
                        Fragment fragment1 = this.c;
        ...
        if(view0 != null) {
            ...
            this.c.mView.setTag(R.b.a, this.c);
            if(viewGroup0 != null) {
                this.b();
            }
            Fragment fragment2 = this.c;
    ...
    void g() {
        ...
        if(z1) {
            ...
            if(!fragment0.mBeingSaved) {
                this.b.B(fragment0.mWho, null);
            }
        }
        if(!z1 && !this.b.p().r(this.c)) {
        ...
        else if(m0.g() instanceof Activity) {
            z = true ^ ((Activity)m0.g()).isChangingConfigurations();
        }
    ...
    void h() {
        ...
        this.c.mViewLifecycleOwnerLiveData.j(null);
    ...
    void i() {
        ...
        if(this.c.mRemoving && !this.c.isInBackStack() || this.b.p().r(this.c)) {
            if(FragmentManager.H0(3)) {
        ...
        try {
            ...
            for(z = false; true; z = true) {
                ...
                if(v1 > v2) {
                    switch(v2 + 1) {
                        ...
                        case 4: {
                            if(fragment0.mView != null) {
                                ViewGroup viewGroup0 = fragment0.mContainer;
                                if(viewGroup0 != null) {
                                    F.n(viewGroup0, fragment0.getParentFragmentManager()).b(androidx.fragment.app.F.e.c.f(this.c.mView.getVisibility()), this);
                                }
                            }
                            this.c.mState = 4;
                            break;
                    ...
                    switch(v2 - 1) {
                        ...
                        case 0: {
                            if(fragment0.mBeingSaved && this.b.q(fragment0.mWho) == null) {
                                this.r();
                            }
                            this.g();
                            break;
                        ...
                        case 3: {
                            ...
                            if(fragment2.mView != null) {
                                ...
                                if(viewGroup1 != null) {
                                    F.n(viewGroup1, fragment2.getParentFragmentManager()).d(this);
                                }
                            }
                            this.c.mState = 3;
                            break;
            ...
            if(fragment3.mHiddenChanged) {
                if(fragment3.mView != null) {
                    ...
                    if(viewGroup2 != null) {
                        F f0 = F.n(viewGroup2, fragment3.getParentFragmentManager());
                        if(this.c.mHidden) {
                            f0.c(this);
                        }
                        else {
    ...
    void r() {
        ...
        Fragment fragment0 = this.c;
        if(fragment0.mState <= -1 || fragmentState0.r != null) {
            fragmentState0.r = fragment0.mSavedFragmentState;
        }
        else {
            Bundle bundle0 = this.q();
            fragmentState0.r = bundle0;
            if(this.c.mTargetWho != null) {
                if(bundle0 == null) {
                    fragmentState0.r = new Bundle();
                }
                fragmentState0.r.putString("android:target_state", this.c.mTargetWho);
                int v = this.c.mTargetRequestCode;
                if(v != 0) {
                    fragmentState0.r.putInt("android:target_req_state", v);
                }
            }
        }
        this.b.B(this.c.mWho, fragmentState0);
    }
