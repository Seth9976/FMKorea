...
public final class b {
    ...
    public void c() {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            ArrayList arrayList0 = (ArrayList)this.b.n(v1);
            if(arrayList0 != null) {
                this.k(arrayList0);
            }
        }
    ...
    public List h(Object object0) {
        ...
        for(int v1 = 0; v1 < v; ++v1) {
            ...
            if(arrayList0 != null && arrayList0.contains(object0)) {
                ...
                ((ArrayList)list0).add(this.b.j(v1));
            }
        }
        return list0;
    }
    ...
    public ArrayList i() {
        ...
        int v = this.b.size();
        for(int v1 = 0; v1 < v; ++v1) {
            this.e(this.b.j(v1), this.c, this.d);
        }
        return this.c;
    }
    ...
    private void k(ArrayList arrayList0) {
        arrayList0.clear();
        this.a.a(arrayList0);
    }
}
