...
public class t extends RadioButton implements k, l {
    private final i f;
    private final d g;
    private final z h;
    private m i;

    public t(Context context0, AttributeSet attributeSet0) {
        this(context0, attributeSet0, a.G);
    }

    public t(Context context0, AttributeSet attributeSet0, int v) {
