...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private static int B(View view0) {
        int v = Y.A(view0);
        if(v > 0) {
            return v;
        }
        return !(view0 instanceof ViewGroup) || ((ViewGroup)view0).getChildCount() != 1 ? 0 : AlertDialogLayout.B(((ViewGroup)view0).getChildAt(0));
    }
    ...
    protected void onLayout(boolean z, int v, int v1, int v2, int v3) {
        ...
        for(int v13 = 0; v13 < v9; ++v13) {
            ...
            if(view0 != null && view0.getVisibility() != 8) {
                ...
                a linearLayoutCompat$a0 = (a)view0.getLayoutParams();
                switch(s.b((linearLayoutCompat$a0.gravity >= 0 ? linearLayoutCompat$a0.gravity : v10 & 0x800007), this.getLayoutDirection()) & 7) {
                    case 1: {
                        v16 = (v5 - v4 - v7 - v14) / 2 + v4 + linearLayoutCompat$a0.leftMargin - linearLayoutCompat$a0.rightMargin;
                        break;
                    }
                    case 5: {
                        v16 = v5 - v6 - v14 - linearLayoutCompat$a0.rightMargin;
                        break;
                    }
                    default: {
                        v16 = linearLayoutCompat$a0.leftMargin + v4;
                    }
                }
                if(this.t(v13)) {
                    v11 += v12;
                }
                int v17 = v11 + linearLayoutCompat$a0.topMargin;
                this.A(view0, v16, v17, v14, v15);
                v11 = v17 + (v15 + linearLayoutCompat$a0.bottomMargin);
            }
        }
    }
