...
class l0 {
    ...
    l0(Context context0) {
        ...
        this.g = new int[2];
        this.a = context0;
        View view0 = LayoutInflater.from(context0).inflate(g.s, null);
        this.b = view0;
        this.c = (TextView)view0.findViewById(f.s);
        windowManager$LayoutParams0.setTitle(this.getClass().getSimpleName());
        windowManager$LayoutParams0.packageName = "com.fmkorea.m.fmk";
        ...
        windowManager$LayoutParams0.windowAnimations = i.a;
    ...
    private void a(View view0, int v, int v1, boolean z, WindowManager.LayoutParams windowManager$LayoutParams0) {
        ...
        int v2 = this.a.getResources().getDimensionPixelOffset(d.k);
        if(view0.getWidth() < v2) {
            v = view0.getWidth() / 2;
        }
        if(view0.getHeight() >= v2) {
            int v3 = this.a.getResources().getDimensionPixelOffset(d.j);
            v4 = v1 + v3;
            v5 = v1 - v3;
        }
        else {
        ...
        int v6 = this.a.getResources().getDimensionPixelOffset((z ? d.m : d.l));
        View view1 = l0.b(view0);
        if(view1 == null) {
