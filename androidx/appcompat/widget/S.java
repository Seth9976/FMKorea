...
class s {
    ...
    static {
        s.c = new int[]{0x101013B, 0x101013C};
    }

    s(ProgressBar progressBar0) {
        this.a = progressBar0;
    }
    ...
    Drawable d(Drawable drawable0, boolean z) {
        if(drawable0 instanceof b) {
            Drawable drawable1 = ((b)drawable0).b();
            if(drawable1 != null) {
                ((b)drawable0).a(this.d(drawable1, z));
                return drawable0;
            }
        }
        else {
            if(drawable0 instanceof LayerDrawable) {
                ...
                for(int v1 = 0; v1 < v; ++v1) {
                    ...
                    a.a(((LayerDrawable)drawable0), ((LayerDrawable)drawable2), v1);
                }
                return drawable2;
            }
