...
class d extends Drawable {
    ...
    d(ColorStateList colorStateList0, float f) {
        this.f = false;
        this.g = true;
    ...
    public void f(ColorStateList colorStateList0) {
        this.e(colorStateList0);
        this.invalidateSelf();
    }
    ...
    private void i(Rect rect0) {
        ...
        this.d.set(rect0);
        if(this.f) {
            float f = e.b(this.e, this.a, this.g);
            int v = (int)Math.ceil(e.a(this.e, this.a, this.g));
