...
public class PreferenceImageView extends ImageView {
    ...
    public PreferenceImageView(Context context0, AttributeSet attributeSet0, int v) {
        ...
        this.f = 0x7FFFFFFF;
        this.g = 0x7FFFFFFF;
        TypedArray typedArray0 = context0.obtainStyledAttributes(attributeSet0, s.D0, v, 0);
        this.setMaxWidth(typedArray0.getDimensionPixelSize(s.F0, 0x7FFFFFFF));
        this.setMaxHeight(typedArray0.getDimensionPixelSize(s.E0, 0x7FFFFFFF));
        typedArray0.recycle();
    }
